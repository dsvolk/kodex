...
pub(crate) const CLASSIFICATION_TRUNCATION_METRIC: &str =
    "kodex.guardian_v2.classification.truncation";
pub(crate) const CLASSIFICATION_TRUNCATION_BYTES_METRIC: &str =
    "kodex.guardian_v2.classification.truncation.bytes";

pub(crate) use kodex_guardian_context::TruncationObservation;
