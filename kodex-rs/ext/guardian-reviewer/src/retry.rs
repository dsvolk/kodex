...
fn should_retry_guardian_review(outcome: &GuardianReviewOutcome) -> bool {
    match outcome {
        ...
        GuardianReviewOutcome::Error(GuardianReviewError::Session {
            ...
            | KodexErrorInfo::InternalServerError => true,
            ...
            KodexErrorInfo::ContextWindowExceeded
            | KodexErrorInfo::SessionBudgetExceeded
            | KodexErrorInfo::UsageLimitExceeded
            | KodexErrorInfo::CyberPolicy
            | KodexErrorInfo::BioPolicy
            | KodexErrorInfo::MisalignmentPolicyViolation
            | KodexErrorInfo::Unauthorized
            | KodexErrorInfo::BadRequest
            | KodexErrorInfo::SandboxError
            | KodexErrorInfo::ActiveTurnNotSteerable { .. }
            | KodexErrorInfo::ThreadRollbackFailed
            | KodexErrorInfo::Other => false,
        },
