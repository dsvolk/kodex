...
const USAGE_URL: &str = "https://chatgpt.com/kodex/settings/usage";
...
impl BackendBanner {
    pub(super) fn resolve_action(&self, action: &str) -> Option<BannerAction> {
        ...
        let destination = match action {
            ...
            {
                "https://chatgpt.com/admin/billing?kodex_credit_action=add_credits".to_string()
            }
            "add_credits" | "buy_credits" => format!("{USAGE_URL}?credits_modal=true"),
            "buy_reset" => "https://chatgpt.com/kodex/purchase/reset".to_string(),
