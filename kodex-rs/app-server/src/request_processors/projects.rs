...
use kodex_app_server_protocol::Project;
use kodex_app_server_protocol::ProjectChangeType;
use kodex_app_server_protocol::ProjectChangedNotification;
...
use kodex_app_server_protocol::ProjectDeleteResponse;
use kodex_app_server_protocol::ProjectImportParams;
use kodex_app_server_protocol::ProjectImportResponse;
use kodex_app_server_protocol::ProjectListParams;
use kodex_app_server_protocol::ProjectListResponse;
use kodex_app_server_protocol::ProjectMoveParams;
use kodex_app_server_protocol::ProjectMoveResponse;
use kodex_app_server_protocol::ProjectReadParams;
use kodex_app_server_protocol::ProjectReadResponse;
use kodex_app_server_protocol::ProjectRoot;
use kodex_app_server_protocol::ProjectSortKey;
use kodex_app_server_protocol::ProjectUpdateParams;
use kodex_app_server_protocol::ProjectUpdateResponse;
...
use kodex_thread_store::CreateProjectParams as StoreCreateProjectParams;
use kodex_thread_store::ListProjectsParams as StoreListProjectsParams;
use kodex_thread_store::MoveProjectParams as StoreMoveProjectParams;
use kodex_thread_store::ProjectMoveOutcome;
use kodex_thread_store::ProjectSortKey as StoreProjectSortKey;
use kodex_thread_store::SortDirection as StoreSortDirection;
use kodex_thread_store::StoredProject;
use kodex_thread_store::StoredProjectRoot;
use kodex_thread_store::ThreadStore;
use kodex_thread_store::ThreadStoreError;
use kodex_thread_store::UpdateProjectParams as StoreUpdateProjectParams;
...
fn validate_roots(roots: Vec<ProjectRoot>) -> Result<Vec<StoredProjectRoot>, JSONRPCErrorError> {
    ...
    roots
        .into_iter()
        .map(|root| {
            let path = kodex_utils_absolute_path::AbsolutePathBuf::from_absolute_path_checked(
...
fn api_project(project: StoredProject) -> Result<Project, JSONRPCErrorError> {
    Ok(Project {
        ...
        roots: project
            ...
            .map(|root| {
                Ok(ProjectRoot {
                    path: kodex_utils_absolute_path::AbsolutePathBuf::from_absolute_path(root.path)
                        .map_err(|error| {
