...
#[serde(
    remote = "KodexErrorInfo",
    rename = "KodexErrorInfo",
    rename_all = "snake_case"
)]
enum KodexErrorInfoWire {
...
impl Serialize for KodexErrorInfo {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        KodexErrorInfoWire::serialize(self, serializer)
    }
}

impl<'de> Deserialize<'de> for KodexErrorInfo {
        ...
        D: Deserializer<'de>,
    {
        ...
        if let Value::Object(fields) = &value
            ...
            && kind != "other"
            && matches!(
                KodexErrorInfoWire::deserialize(Value::String(kind.clone())),
                Ok(Self::Other)
            )
        {
            return Ok(Self::Other);
        }
        KodexErrorInfoWire::deserialize(value).map_err(D::Error::custom)
    }
}
