...
use kodex_core::context::MemoryContextFragment;
...
/// Contributes Kodex memory read-path prompt context and memory read tools.
    ...
    fn contribute_thread_context<'a>(
        ...
        Box::pin(async move {
            ...
            let Some(instructions) =
                build_memory_tool_developer_instructions(&config.kodex_home, config.version).await
            else {
                return Vec::new();
            };
