...
#[test_case("mcp__kodex_apps__slack__send_message", json!({"text": "Staging only?"}), true; "other_app")]
#[test_case("mcp__kodex_apps__user_messaging__send_message", json!({"text": "Staging only?"}), false; "failed_send")]
#[test_case("mcp__kodex_apps__user_messaging__send_message", json!({"text": " "}), true; "empty_text")]
