...
const SETUP_BIN: &str = "kodex-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "kodex-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so Kodex binaries that link the
