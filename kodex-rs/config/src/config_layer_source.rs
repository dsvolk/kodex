...
/// Provenance for one layer in the effective Kodex configuration.
...
pub enum ConfigLayerSource {
    ...
    /// Configuration loaded from a project's `.kodex` directory.
    Project { dot_kodex_folder: AbsolutePathBuf },
    ...
    match source {
        ...
        ConfigLayerSource::Project { dot_kodex_folder } => {
            format!(
                ...
                dot_kodex_folder.as_path().display()
            )
        }
