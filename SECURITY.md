...
Thank you for helping us keep Kodex secure!
...
## How to operate KODEX safely

For details on Kodex security boundaries, including sandboxing, approvals, and network controls, see [Agent approvals & security](https://developers.openai.com/kodex/agent-approvals-security).
