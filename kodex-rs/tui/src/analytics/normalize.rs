            ...
            Report::Messages => {
                ...
                if grouping == Grouping::Model {
                    for model in record.models.unwrap_or_default() {
                        let key = if model.model.eq_ignore_ascii_case("kodex-auto-review")
                    ...
                    for client in record.clients.unwrap_or_default() {
                        ...
                        let key = match client.client_id.as_str() {
                            "KODEX_CLI" => "cli",
                            "KODEX_IDE_VSCODE" => "vscode",
                            "KODEX_WEB" => "web",
                            "KODEX_DESKTOP_APP" | "KODEX_WORK_DESKTOP" => "desktop_app",
                            "KODEX_WORK_WEB" => "work_web",
                            "KODEX_WORK_MOBILE" => "mobile",
                            "KODEX_GITHUB" => "github_code_review",
                            _ => "other",
                        };
