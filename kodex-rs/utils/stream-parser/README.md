# kodex-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Kodex did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Kodex on it. Feel free to update the documentation as you
modify the code
...
```rust
use kodex_utils_stream_parser::CitationStreamParser;
use kodex_utils_stream_parser::StreamTextParser;
...
```rust
use kodex_utils_stream_parser::CitationStreamParser;
use kodex_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), kodex_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use kodex_utils_stream_parser::InlineHiddenTagParser;
use kodex_utils_stream_parser::InlineTagSpec;
use kodex_utils_stream_parser::StreamTextParser;
