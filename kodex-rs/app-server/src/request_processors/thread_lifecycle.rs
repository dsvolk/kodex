...
pub(super) async fn wait_for_thread_shutdown(thread: &Arc<KodexThread>) -> ThreadShutdownResult {
...
fn merge_active_turn_into_page(
    page: &mut kodex_app_server_protocol::TurnsPage,
    mut active_turn: Turn,
    params: &kodex_app_server_protocol::ThreadResumeInitialTurnsPageParams,
) {
