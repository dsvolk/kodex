...
3. When the current documentation supports it, the local Kodex CLI setup is:

   ```sh
   kodex mcp add openaiDeveloperDocs --url https://developers.openai.com/mcp
   ```
