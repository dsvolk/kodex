...
pub(crate) struct LocalSettings {
    ...
    pub(crate) kodex_home: AbsolutePathBuf,
    ...
    fn with_accessibility_preferences(
        ...
        Self {
            transcript_mode: TranscriptMode::resolve(
                ...
                config.tui_alternate_screen != kodex_config::types::AltScreenMode::Never,
            ),
            tui: Tui {
            ...
            user_config_path: config
                ...
                .cloned()
                .unwrap_or_else(|| config.kodex_home.join("config.toml")),
        }
    }
}
...
impl LocalSettings {
    ...
    pub(crate) fn for_tui(config: &Config, tui: &crate::tui::Tui) -> Self {
        ...
        if !tui.is_alt_screen_enabled() {
            settings.tui.alternate_screen = kodex_config::types::AltScreenMode::Never;
        } else if settings.tui.alternate_screen == kodex_config::types::AltScreenMode::Never {
            settings.tui.alternate_screen = kodex_config::types::AltScreenMode::Auto;
        }
        settings
    }
