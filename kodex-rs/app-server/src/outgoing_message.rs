...
use kodex_app_server_protocol::Result;
...
use kodex_otel::span_w3c_trace_context;
...
pub(crate) use kodex_app_server_transport::ConnectionId;
pub(crate) use kodex_app_server_transport::OutgoingError;
pub(crate) use kodex_app_server_transport::OutgoingMessage;
pub(crate) use kodex_app_server_transport::OutgoingResponse;
pub(crate) use kodex_app_server_transport::QueuedOutgoingMessage;
...
pub(crate) struct OutgoingMessageSender {
    verification_auth: OnceLock<Arc<kodex_login::AuthManager>>,
    ...
    pub(crate) async fn send_request_to_connections(
        ...
        let user_verification = matches!(
            ...
            ServerRequest::McpServerElicitationRequest { params, .. }
                if matches!(&params.request, kodex_app_server_protocol::McpServerElicitationRequest::UserVerification { .. })
        );
...
mod tests {
    ...
    use kodex_app_server_protocol::ApplyPatchApprovalParams;
    ...
    use kodex_app_server_protocol::ModelRerouteReason;
    use kodex_app_server_protocol::ModelReroutedNotification;
    use kodex_app_server_protocol::ModelVerification;
    ...
    fn verify_model_rerouted_notification_serialization() {
        let notification = ServerNotification::ModelRerouted(ModelReroutedNotification {
            ...
            from_model: "gpt-5.3-kodex".to_string(),
    ...
    async fn send_response_routes_to_target_connection() {
        ...
        let outgoing =
            OutgoingMessageSender::new(tx, kodex_analytics::AnalyticsEventsClient::disabled());
        ...
        outgoing
            .send_response(
                ...
                ClientResponsePayload::ThreadArchive(
                    kodex_app_server_protocol::ThreadArchiveResponse {},
                ),
            )
            .await;
