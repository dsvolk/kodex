...
const SESSION_NAME: &str = "Kodex Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Kodex Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Kodex Windows sandbox filters";
const SUBLAYER_NAME: &str = "Kodex Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Kodex Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Kodex-owned identities; do not regenerate them unless we
...
/// Installs the persistent Kodex WFP filters for `account`.
///
...
/// Ensures the persistent Kodex WFP provider exists.
...
/// Ensures the persistent Kodex sublayer exists under the Kodex provider.
