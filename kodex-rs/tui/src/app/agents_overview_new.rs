...
pub(crate) struct PendingWorktree {
    pub(in crate::app) manager: kodex_worktree::WorktreeManager,
    pub(in crate::app) checkout: Option<kodex_worktree::ManagedWorktree>,
}
...
impl App {
    ...
    pub(in crate::app) async fn new_agents_overview_worktree(
        ...
        let setup = async {
            ...
            anyhow::Ok(kodex_worktree::WorktreeManager::new(settings))
        }
        .await;
        ...
        tokio::spawn(async move {
            let result = tokio::task::spawn_blocking(move || {
                kodex_worktree::default_worktree_base(config.cwd.as_path())
                    .and_then(|base| {
                        manager.create(&kodex_worktree::CreateWorktree {
