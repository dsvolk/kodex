...
use kodex_apply_patch::ApplyPatchOptions;
...
use kodex_sandboxing::is_likely_executor_managed_sandbox_denied;
...
impl ToolRuntime<ApplyPatchRequest, ApplyPatchRuntimeOutput> for ApplyPatchRuntime {
    ...
    async fn run(
        ...
        let result = kodex_apply_patch::apply_patch_with_options(
            &req.action.patch,
            ApplyPatchOptions {
