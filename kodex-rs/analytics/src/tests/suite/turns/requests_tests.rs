...
use kodex_app_server_protocol::NonSteerableTurnKind;
            ...
            AnalyticsFact::Initialize {
                ...
                params: InitializeParams {
                    client_info: ClientInfo {
                        name: "kodex-web".to_string(),
                        title: None,
                        version: "1.0.0".to_string(),
                    },
                    capabilities: None,
                },
                product_client_id: "kodex-web".to_string(),
...
async fn accepted_turn_steer_emits_expected_event() {
    ...
    assert_eq!(payload["event_type"], json!("kodex_turn_steer_event"));
    ...
    assert_eq!(
        payload["event_params"]["runtime"]["kodex_rs_version"],
        json!("0.1.0")
    );
...
async fn rejected_turn_interrupt_does_not_tag_interrupted_turn_event() {
    ...
    assert_eq!(payload["event_params"]["kodex_error_kind"], json!(null));
}
