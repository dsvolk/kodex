...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: Kodex is rebuilding normal terminal scrollback, not an
...
use kodex_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
