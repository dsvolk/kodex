...
pub(crate) struct AnalyticsView {
    ...
    chat_metric: usize,
    profile: Load<kodex_backend_client::AccountProfile>,
    plan: plan::State,
    show_zero_credit_groups: bool,
    account: Load<kodex_protocol::account::PlanType>,
...
impl AnalyticsView {
    ...
    pub(crate) fn open(
        ...
        models: Vec<kodex_protocol::openai_models::ModelPreset>,
        ...
        self.plan.enabled = config
            .features
            .enabled(kodex_features::Feature::AnalyticsPlanHistory);
                    ...
                    live.session().await.map(|session| {
                        Some(
                            session
                                ...
                                .account()
                                .plan_type
                                .unwrap_or(kodex_protocol::account::PlanType::Unknown),
                        )
                    })
                },
                frame.clone(),
