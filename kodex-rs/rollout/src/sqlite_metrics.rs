...
use kodex_otel::ORIGINATOR_TAG;
use kodex_otel::bounded_originator_tag_value;
use kodex_state::DbTelemetry;
use kodex_state::DbTelemetryHandle;
use kodex_state::LOG_WRITE_BYTES_METRIC;
use kodex_state::LOG_WRITE_MAX_ENTRY_BYTES_METRIC;
...
pub(crate) fn recorder(metrics: kodex_otel::MetricsClient, originator: &str) -> DbTelemetryHandle {
