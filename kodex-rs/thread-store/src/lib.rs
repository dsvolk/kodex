...
//!
//! Application code should treat [`kodex_protocol::ThreadId`] as the only durable thread handle.
...
pub use kodex_state::AddThreadAttachmentOutcome;
pub use kodex_state::MAX_QUEUE_ITEMS;
pub use kodex_state::MAX_THREAD_ATTACHMENT_PAYLOAD_BYTES;
pub use kodex_state::ProjectSortKey;
pub use kodex_state::QueuedUserSubmissionRecord;
pub use kodex_state::RemoveThreadAttachmentOutcome;
pub use kodex_state::ThreadAttachment;
pub use kodex_state::ThreadAttachmentPage;
