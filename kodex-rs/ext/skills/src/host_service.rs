...
use kodex_config::bundled_skills_enabled_from_stack;
...
use kodex_skills::install_system_skills;
...
impl HostSkillsService {
    pub fn new(kodex_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(kodex_home, bundled_skills_enabled, Some(Product::Kodex))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        // The cache is shared by every process using this KODEX_HOME. Disabled services filter
    ...
    fn ensure_system_skills_installed(&self) {
        if let Err(err) = install_system_skills(&self.kodex_home) {
