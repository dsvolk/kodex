...
use kodex_mcp::hosted_plugin_runtime_mcp_server_config;
...
pub use kodex_core_plugins::PluginListQuery;
pub use kodex_core_plugins::PluginProvider;
pub use kodex_core_plugins::PluginProviderError;
pub use kodex_core_plugins::PluginProviderFuture;
pub use kodex_core_plugins::PluginProviderResult;
...
impl McpServerContributor<Config> for HostedPluginRuntimeExtension {
    ...
    fn contribute<'a>(
        ...
        Box::pin(async move {
            ...
            let name = KODEX_APPS_MCP_SERVER_NAME.to_string();
            if !config.features.enabled(kodex_features::Feature::Apps) {
