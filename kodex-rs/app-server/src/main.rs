...
const MANAGED_CONFIG_PATH_ENV_VAR: &str = "KODEX_APP_SERVER_MANAGED_CONFIG_PATH";
    ...
    arg0_dispatch_or_else(move |arg0_paths: Arg0DispatchPaths| async move {
        ...
        runtime_options.remote_control_startup_mode =
            match (remote_control, remote_control_disabled) {
                (true, _) => kodex_app_server::RemoteControlStartupMode::EnabledEphemeral,
                (false, true) => kodex_app_server::RemoteControlStartupMode::DisabledEphemeral,
                (false, false) => kodex_app_server::RemoteControlStartupMode::ResolvePersisted,
            };
