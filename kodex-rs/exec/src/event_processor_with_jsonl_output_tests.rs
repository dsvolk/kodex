...
fn failed_turn_does_not_overwrite_output_last_message_file() {
    ...
    let status = processor.process_server_notification(ServerNotification::TurnCompleted(
        kodex_app_server_protocol::TurnCompletedNotification {
            ...
            turn: kodex_app_server_protocol::Turn {
                ...
                error: Some(kodex_app_server_protocol::TurnError {
                    misalignment: None,
    ...
    assert_eq!(status, KodexStatus::InitiateShutdown);
    ...
    let collected = processor.collect_thread_events(ServerNotification::ItemCompleted(
        kodex_app_server_protocol::ItemCompletedNotification {
            item: ThreadItem::McpToolCall {
                ...
                arguments: json!({"search_query": [{"q": "OpenAI Kodex CLI documentation"}]}),
                app_context: None,
