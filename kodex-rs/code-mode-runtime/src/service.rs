...
use kodex_code_mode_protocol::CodeModeSession;
use kodex_code_mode_protocol::CodeModeSessionCellExecutionLimits;
use kodex_code_mode_protocol::CodeModeSessionDelegate;
use kodex_code_mode_protocol::CodeModeSessionResultFuture;
use kodex_code_mode_protocol::CodeModeToolKind;
use kodex_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use kodex_code_mode_protocol::ExecuteRequest;
use kodex_code_mode_protocol::ExecuteToPendingOutcome;
use kodex_code_mode_protocol::FunctionCallOutputContentItem;
use kodex_code_mode_protocol::ImageDetail;
use kodex_code_mode_protocol::RuntimeResponse;
use kodex_code_mode_protocol::StartedCell;
use kodex_code_mode_protocol::WaitOutcome;
use kodex_code_mode_protocol::WaitRequest;
use kodex_code_mode_protocol::WaitToPendingOutcome;
use kodex_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: kodex_protocol::ToolName {
