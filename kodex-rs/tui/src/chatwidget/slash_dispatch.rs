...
impl ChatWidget {
        ...
        match cmd {
            ...
            SlashCommand::Rename => {
                self.session_telemetry
                    .counter("kodex.thread.rename", /*inc*/ 1, &[]);
            ...
            SlashCommand::ElevateSandbox => {
                #[cfg(target_os = "windows")]
                {
                    ...
                    self.session_telemetry.counter(
                        "kodex.windows_sandbox.setup_elevated_sandbox_command",
                        /*inc*/ 1,
                        &[],
                    );
                    self.app_event_tx
    ...
    pub(super) fn builtin_command_flags(&self) -> BuiltinCommandFlags {
        ...
        BuiltinCommandFlags {
            ...
            token_activity_command_enabled: self.has_kodex_backend_auth,
    ...
    fn ensure_usage_command_available(&mut self) -> bool {
        if self.has_kodex_backend_auth {
            return true;
        }
