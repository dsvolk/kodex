//! Plugin path resolution, plaintext mention sigils, and MCP connector helpers shared across Kodex
//! crates.
...
pub use kodex_exec_server_protocol::DISCOVERABLE_PLUGIN_MANIFEST_PATHS;
...
const PLUGIN_METADATA_DIR: &str = ".kodex-plugin";
