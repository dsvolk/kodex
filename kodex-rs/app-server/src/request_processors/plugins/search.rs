...
use kodex_app_server_protocol::PluginSearchResult;
use kodex_app_server_protocol::PluginSearchScope;
use kodex_core_plugins::OPENAI_BUNDLED_MARKETPLACE_NAME;
use kodex_core_plugins::remote::RemotePluginSearchRequest;
use kodex_core_plugins::remote::search_remote_plugins;
...
impl PluginRequestProcessor {
    ...
    async fn plugin_search_response(
        ...
        let use_remote_global_catalog =
            remote_plugin_enabled && auth_mode.is_some_and(DomainAuthMode::uses_kodex_backend);
        ...
        if auth_mode.is_some_and(DomainAuthMode::uses_kodex_backend)
