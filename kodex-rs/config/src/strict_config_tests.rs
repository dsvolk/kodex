...
fn ignored_toml_field_errors_accept_non_file_source_names() {
    let source_name = "com.openai.kodex:config_toml_base64";
    let contents = r#"
model = "gpt-5"
unknown_key = true"#;
