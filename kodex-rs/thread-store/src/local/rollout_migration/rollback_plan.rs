...
use kodex_rollout::RetainedContextEntry;
use kodex_rollout::RetainedInputSource;
...
impl RollbackPlanner {
    ...
    pub(super) fn observe(&mut self, line: &RolloutLine) -> ThreadStoreResult<()> {
        ...
        match &line.item {
            ...
            RolloutItem::RetainedContext(kodex_rollout::RetainedContextEvent::VerifiedAnswer {
                answer,
                acceptance_order,
            }) => {
