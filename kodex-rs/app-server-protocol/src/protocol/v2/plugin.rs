...
use crate::TS;
use kodex_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use kodex_protocol::protocol::SkillInterface as CoreSkillInterface;
use kodex_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use kodex_protocol::protocol::SkillScope as CoreSkillScope;
use kodex_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// Kodex app-server exposes `"AVAILABLE"` in its API; the alias keeps
