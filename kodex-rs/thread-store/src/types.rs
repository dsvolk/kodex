...
use kodex_protocol::protocol::ThreadMemoryMode as MemoryMode;
...
pub struct CreateThreadParams {
    ...
    /// Thread id generated by Kodex before opening persistence.
...
pub struct StoredTurnError {
    ...
    pub message: String,
    /// Structured Kodex error classification, when available.
...
mod tests {
    ...
    fn session_meta(history_mode: ThreadHistoryMode) -> RolloutItem {
        RolloutItem::SessionMeta(kodex_protocol::protocol::SessionMetaLine {
