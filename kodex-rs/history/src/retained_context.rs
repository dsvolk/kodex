...
use crate::KodexHarnessMetadata;
...
impl From<Option<&KodexHarnessMetadata>> for RetainedInputSource {
    fn from(metadata: Option<&KodexHarnessMetadata>) -> Self {
...
impl RetainedContext {
    ...
    pub fn record_sender_user_messages(&mut self, metadata: &KodexHarnessMetadata) -> bool {
