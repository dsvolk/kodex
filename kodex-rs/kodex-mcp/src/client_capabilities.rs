...
/// Selects the MCP extensions Kodex supports from those declared by the app-server host.
///
/// App-server clients may declare unrelated extensions. Kodex retains only the
