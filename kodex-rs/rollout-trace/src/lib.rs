//! Trace bundle format, writer, and reducer for Kodex rollouts.
//!
//! This crate owns the trace schema. Hot-path Kodex code should depend on the
...
/// Shared recorder context for inference attempts within one Kodex turn.
...
pub use thread::KODEX_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Kodex tool boundary.
...
/// Append-only writer used by hot-path Kodex instrumentation.
