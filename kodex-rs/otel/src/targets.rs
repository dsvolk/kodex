pub(crate) const OTEL_TARGET_PREFIX: &str = "kodex_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "kodex_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "kodex_otel.trace_safe";
