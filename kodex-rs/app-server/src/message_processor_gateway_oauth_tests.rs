...
use anyhow::Result;
use kodex_app_server_protocol::GatewayOAuthLoginResponse;
use kodex_app_server_protocol::GatewayOAuthReadResponse;
...
use kodex_model_provider::test_support::seed_gateway_auth;
...
"#,
    ...
    let auth_manager = AuthManager::from_auth_for_testing_with_home(
        KodexAuth::from_api_key("primary"),
    ...
    kodex_login::default_client::create_client_without_request_logging()
        .get(callback.as_str())
        .send()
        .await?
        .error_for_status()?;
