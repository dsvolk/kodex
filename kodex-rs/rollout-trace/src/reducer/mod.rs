        ...
        match event.payload {
            ...
            RawTraceEventPayload::CodeCellStarted {
                ...
                self.start_or_queue_code_cell(PendingCodeCellStart {
                    ...
                    thread_id,
                    kodex_turn_id: event.kodex_turn_id,
            ...
            RawTraceEventPayload::CompactionInstalled {
                ...
                let Some(kodex_turn_id) = event.kodex_turn_id else {
                    bail!(
                        "compaction installed event {compaction_id} did not include a kodex turn id"
                    );
                };
