use crate::test_kodex::TestKodexBuilder;
use crate::test_kodex::test_kodex;
use anyhow::Result;
...
const KODEX_APPS_META_KEY: &str = "_kodex_apps";
const KODEX_APPS_MCP_PATH_REGEX: &str = "^/api/kodex/ps/mcp/?$";
const HOSTED_PLUGIN_RUNTIME_MCP_PATH_REGEX: &str = "^/api/kodex/ps/mcp/?$";
const PROTOCOL_VERSION: &str = "2025-11-25";
const SERVER_NAME: &str = "kodex-apps-test";
...
pub const DIRECT_CALENDAR_CREATE_EVENT_TOOL: &str = "mcp__kodex_apps__calendar__create_event";
pub const DIRECT_CALENDAR_APP_ONLY_TOOL: &str = "mcp__kodex_apps__calendar__app_only_action";
pub const DIRECT_CALENDAR_LIST_EVENTS_TOOL: &str = "mcp__kodex_apps__calendar__list_events";
pub const DIRECT_CALENDAR_EXTRACT_TEXT_TOOL: &str = "mcp__kodex_apps__calendar__extract_text";
pub const SEARCH_CALENDAR_NAMESPACE: &str = "mcp__kodex_apps__calendar";
...
pub fn apps_enabled_builder(apps_base_url: impl Into<String>) -> TestKodexBuilder {
...
pub fn search_capable_apps_builder(apps_base_url: impl Into<String>) -> TestKodexBuilder {
    let apps_base_url = apps_base_url.into();
    test_kodex()
        .with_auth(KodexAuth::create_dummy_chatgpt_auth_for_testing())
...
async fn mount_streamable_http_json_rpc_with_startup_control(
    ...
    Mock::given(method("POST"))
        ...
        .respond_with(KodexAppsJsonRpcResponder {
            connector_name,
            connector_description,
            searchable,
            include_app_only_tool,
...
struct KodexAppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
    include_app_only_tool: bool,
...
impl Respond for KodexAppsJsonRpcResponder {
        ...
        match method {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let kodex_apps_meta = body.pointer("/params/_meta/_kodex_apps").cloned();
