...
pub(crate) fn build_async_http_client(
    ...
    let mut config = kodex_http_client::HttpClientTlsConfig::default();
    ...
    Ok(crate::network_policy::RuntimeHttpClient {
        client: kodex_http_client::HttpClientBuilder::new()
            .without_request_logging()
            .build_with_tls(factory, kodex_http_client::ClientRouteClass::Other, config),
