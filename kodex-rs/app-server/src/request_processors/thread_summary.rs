...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match kodex_core::parse_turn_item(&item) {
...
pub(super) fn with_thread_spawn_agent_metadata(
    source: kodex_protocol::protocol::SessionSource,
    agent_nickname: Option<String>,
    agent_role: Option<String>,
) -> kodex_protocol::protocol::SessionSource {
...
) -> Option<kodex_app_server_protocol::ActivePermissionProfile> {
