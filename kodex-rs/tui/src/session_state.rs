...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: kodex_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<kodex_protocol::openai_models::ReasoningEffort>,
