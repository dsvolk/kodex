...
use kodex_app_server_protocol::CommandMigration;
...
use kodex_app_server_protocol::ExternalAgentConfigImportHistory;
...
use kodex_app_server_protocol::ExternalAgentDetectedConnectorCandidate;
use kodex_app_server_protocol::ExternalAgentDetectedConnectorSource;
use kodex_app_server_protocol::HookMigration;
use kodex_app_server_protocol::JSONRPCErrorError;
use kodex_app_server_protocol::McpServerMigration;
use kodex_app_server_protocol::MigrationDetails;
use kodex_app_server_protocol::PluginsMigration;
use kodex_app_server_protocol::SkillMigration;
use kodex_app_server_protocol::SubagentMigration;
use kodex_external_agent_migration::DetectedConnectorCandidate as CoreDetectedConnectorCandidate;
use kodex_external_agent_migration::DetectedConnectorSource as CoreDetectedConnectorSource;
use kodex_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use kodex_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use kodex_external_agent_migration::ExternalAgentConfigImportSuccess;
use kodex_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use kodex_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use kodex_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use kodex_external_agent_migration::NamedMigration;
use kodex_external_agent_migration::PluginsMigration as CorePluginsMigration;
use kodex_external_agent_migration::sessions::ExternalAgentSessionMigration;
...
fn protocol_migration_details(details: CoreMigrationDetails) -> MigrationDetails {
    MigrationDetails {
        ...
        sessions: details
            .sessions
            .into_iter()
            .map(|session| kodex_app_server_protocol::SessionMigration {
                path: session.path,
                cwd: session.cwd,
                title: session.title,
            })
...
pub(super) fn protocol_import_history(
    record: kodex_state::ExternalAgentConfigImportHistoryRecord,
