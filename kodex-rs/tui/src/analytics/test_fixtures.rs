...
pub(super) fn chats() -> super::chats::Chats {
    use kodex_backend_client::ThreadUsage;
    use kodex_backend_client::ThreadUsageBreakdownGroup;
    super::chats::Chats {
        rows: [
...
pub(super) fn view(kind: super::models::AccountKind) -> super::AnalyticsView {
    ...
    view.account = super::data::Load::Ready(match kind {
        super::models::AccountKind::Consumer => kodex_protocol::account::PlanType::Plus,
        super::models::AccountKind::Business => kodex_protocol::account::PlanType::Team,
        super::models::AccountKind::Enterprise => {
            kodex_protocol::account::PlanType::EnterpriseCbpUsageBased
        }
        super::models::AccountKind::Unknown => kodex_protocol::account::PlanType::Unknown,
    });
