...
impl ToolCallRuntime {
    ...
    pub(crate) fn handle_tool_call(
    ...
    ) -> impl std::future::Future<Output = Result<ResponseItemEnvelope, KodexErr>> {
        ...
        async move {
            ...
            let mut response = match result {
                ...
                Err(FunctionCallError::Fatal(message)) => return Err(KodexErr::Fatal(message)),
                Err(other) => {
    ...
    fn failure_response(call: ToolCall, err: FunctionCallError) -> ResponseInputItem {
        ...
        match call.payload {
            ...
            ToolPayload::Custom { .. } => ResponseInputItem::CustomToolCallOutput {
                call_id: call.call_id,
                name: None,
                output: kodex_protocol::models::FunctionCallOutputPayload {
                    body: kodex_protocol::models::FunctionCallOutputBody::Text(message),
                    success: Some(false),
                },
            },
        ...
        macro_rules! log_tool_call {
            ($dispatch_duration_ms:expr, $handler_duration_ms:expr, $total_duration_ms:expr) => {
                info!(
                    ...
                    trace_id = %kodex_otel::current_span_trace_id().unwrap_or_default(),
...
mod tests {
    ...
    fn tool_call_timing_guard_ignores_code_mode_source() {
        ...
        tracing::subscriber::with_default(subscriber, || {
            let call = ToolCall {
                tool_name: kodex_tools::ToolName::plain("test_tool"),
    ...
    fn output_timing_works_without_logs_and_excludes_dispatch_waiting() {
        tracing::subscriber::with_default(tracing::subscriber::NoSubscriber::default(), || {
            let call = ToolCall {
                tool_name: kodex_tools::ToolName::plain("exec"),
                call_id: "call-1".to_string(),
    ...
    async fn cancellation_before_dispatch_admission_logs_dispatch_only_timing() -> anyhow::Result<()>
    {
        ...
        let tool_name = kodex_tools::ToolName::plain("test_tool");
        ...
        let timing_events = logs
            .lines()
            .filter(|line| line.contains("event.name=\"kodex.tool_call\""))
            .collect::<Vec<_>>();
        assert_eq!(
            timing_events.len(),
            1,
    ...
    impl kodex_extension_api::ToolLifecycleContributor for BlockingFinishContributor {
        fn on_tool_finish<'a>(
            &'a self,
    ...
    -> anyhow::Result<()> {
        ...
        let mut builder =
            kodex_extension_api::ExtensionRegistryBuilder::<crate::config::Config>::new();
