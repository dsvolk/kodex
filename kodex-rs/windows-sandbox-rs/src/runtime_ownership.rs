...
pub const APP_CORE_RUNNER_ALIAS: &str = "kodex-core-command-runner.exe";
...
pub const CORE_INSTALLATION_KEY: &str =
    r"SOFTWARE\OpenAI\Kodex\WindowsSandboxService\RegisteredCore";
...
impl InstallationRecord {
    ...
    pub fn admit_owner(&self, owner: &InstallationRecord, family: &str) -> Result<()> {
            ...
            self.user_sid == owner.user_sid
                && self.kodex_home == owner.kodex_home
