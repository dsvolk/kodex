...
use kodex_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use kodex_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use kodex_protocol::turn_input::CyberAccessProgram as CoreCyberAccessProgram;
use kodex_protocol::user_input::ByteRange as CoreByteRange;
use kodex_protocol::user_input::TextElement as CoreTextElement;
...
/// Requested cyber treatment for a ChatGPT-authenticated Kodex turn.
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich Kodex's ResponsesAPI turn metadata.
    ///
    /// Entries are flattened into the JSON string sent as
    /// `client_metadata["x-kodex-turn-metadata"]` on ResponsesAPI HTTP and websocket requests.
    ///
