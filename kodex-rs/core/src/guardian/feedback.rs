...
pub(super) async fn record_failed_review(
    ...
    let Some(feedback) = kodex_guardian_reviewer::FailedReviewFeedback::for_outcome(
        outcome,
        kodex_guardian_reviewer::ReviewFeedbackSettings {
    ...
    feedback.store(kodex_guardian_reviewer::ReviewFeedbackContext {
