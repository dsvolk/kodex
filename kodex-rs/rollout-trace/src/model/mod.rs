...
/// Kodex conversation/session UUID.
...
/// Process/session ID returned by Kodex's terminal runtime.
...
/// Canonical reduced graph for one Kodex rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the Kodex rollout/session being observed. `trace_id`
    ...
    pub kodex_turns: BTreeMap<KodexTurnId, KodexTurn>,
