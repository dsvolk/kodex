...
fn app_mentioned_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppMentioned(KodexAppMentionedEventRequest {
        event_type: "kodex_app_mentioned",
        event_params: kodex_app_metadata(
            &tracking,
            AppInvocation {
...
fn app_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppUsed(KodexAppUsedEventRequest {
        event_type: "kodex_app_used",
        event_params: KodexAppUsedMetadata {
            app: kodex_app_metadata(
                &tracking,
                AppInvocation {
