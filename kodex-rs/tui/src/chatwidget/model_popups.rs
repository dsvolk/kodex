...
impl ChatWidget {
    ...
    pub(super) fn is_auto_model(model: &str) -> bool {
        model.starts_with("kodex-auto-")
    }

    fn auto_model_order(model: &str) -> usize {
        match model {
            "kodex-auto-fast" => 0,
            "kodex-auto-balanced" => 1,
            "kodex-auto-thorough" => 2,
            _ => 3,
        }
    }
    ...
    pub(crate) fn open_reasoning_popup(&mut self, preset: ModelPreset) {
        ...
        let warn_for_model = preset.model.starts_with("gpt-5.1-kodex")
            || preset.model.starts_with("gpt-5.1-kodex-max")
