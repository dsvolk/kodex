...
use kodex_analytics::SkillInvocation;
use kodex_analytics::SkillInvocationLocation;
...
use kodex_extension_api::ThreadOriginator;
...
impl SkillToolAuthority {
    ...
    pub(crate) fn from_authority(authority: &SkillAuthority) -> Option<Self> {
        match &authority.kind {
            SkillSourceKind::Orchestrator if authority.id == KODEX_APPS_MCP_SERVER_NAME => {
