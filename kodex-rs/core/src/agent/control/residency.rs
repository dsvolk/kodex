...
impl LocalAgentRuntime {
    ...
    ) -> KodexResult<Option<tokio::sync::OwnedRwLockReadGuard<()>>> {
...
fn is_resident_candidate(thread: &KodexThread) -> bool {
...
async fn is_unloadable(thread: &KodexThread) -> bool {
    matches!(
