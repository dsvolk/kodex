...
use kodex_extension_api::GuardianV2Enabled;
...
use kodex_protocol::openai_models::GuardianUnscoredAction as UnscoredAction;
...
impl GuardianV2Extension {
    pub(super) async fn score_tool(&self, input: ToolStartInput<'_>) {
        ...
        let kodex_core::context::GuardianUserInputSnapshot {
