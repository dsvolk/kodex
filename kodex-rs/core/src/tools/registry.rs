...
use kodex_analytics::ControlToolCallStatus;
...
use kodex_shell_command::parse_command::parse_shell_script;
...
pub use kodex_tools::ToolExposure;
...
impl AnyToolResult {
    pub(crate) fn into_response(self) -> ResponseItemEnvelope {
        ...
        ResponseItemEnvelope {
            ...
            metadata: history_truncation_token_limit.map(|limit| KodexHarnessMetadata {
