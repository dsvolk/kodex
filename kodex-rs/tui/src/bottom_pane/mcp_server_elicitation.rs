...
use kodex_app_server_protocol::McpElicitationEnumSchema;
use kodex_app_server_protocol::McpElicitationPrimitiveSchema;
use kodex_app_server_protocol::McpElicitationSingleSelectEnumSchema;
...
use kodex_protocol::mcp_approval_meta::APPROVAL_KIND_KEY as APPROVAL_META_KIND_KEY;
use kodex_protocol::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as APPROVAL_META_KIND_MCP_TOOL_CALL;
use kodex_protocol::mcp_approval_meta::APPROVAL_KIND_TOOL_SUGGESTION as APPROVAL_META_KIND_TOOL_SUGGESTION;
use kodex_protocol::mcp_approval_meta::PERSIST_ALWAYS as APPROVAL_PERSIST_ALWAYS_VALUE;
use kodex_protocol::mcp_approval_meta::PERSIST_KEY as APPROVAL_PERSIST_KEY;
use kodex_protocol::mcp_approval_meta::PERSIST_SESSION as APPROVAL_PERSIST_SESSION_VALUE;
use kodex_protocol::mcp_approval_meta::TOOL_NAME_KEY;
use kodex_protocol::mcp_approval_meta::TOOL_PARAMS_DISPLAY_KEY as APPROVAL_TOOL_PARAMS_DISPLAY_KEY;
use kodex_protocol::mcp_approval_meta::TOOL_PARAMS_KEY as APPROVAL_TOOL_PARAMS_KEY;
...
mod tests {
    ...
    fn switching_fields_clears_length_validation_flash() {
        ...
        overlay.handle_paste("x".repeat(kodex_protocol::user_input::MAX_USER_INPUT_TEXT_CHARS + 1));
