...
#   filename:  kodex_app_server_protocol.v2.schemas.json
...
class KodexAppServerProtocolV2(BaseModel):
    pass
...
class AmazonBedrockAccount(BaseModel):
    ...
    uses_kodex_managed_credentials: Annotated[
        bool | None, Field(alias="usesKodexManagedCredentials")
    ] = False
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_kodex_folder: Annotated[AbsolutePathBuf, Field(alias="dotKodexFolder")]
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, Kodex attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class RateLimitResetType(Enum):
    kodex_rate_limits = "kodexRateLimits"
    unknown = "unknown"
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `kodex_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    kodex_streamlined_login: Annotated[bool | None, Field(alias="kodexStreamlinedLogin")] = None
...
class WebSearchThreadItem(BaseModel):
    ...
    results: Annotated[
        list | None,
        Field(
            description="Structured search results returned out-of-band by standalone web search.\n\nThese stay as opaque JSON at the extension/app-server boundary so new result fields and result types can pass through without a Kodex release."
        ),
    ] = None
...
class TurnError(BaseModel):
    ...
    kodex_error_info: Annotated[KodexErrorInfo | None, Field(alias="kodexErrorInfo")] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `kodex`).",
        ),
    ] = None
...
class Turn(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this turn. Kodex-generated turn IDs are UUIDv7.")
    ]
    items: Annotated[
...
class Thread(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this thread. Kodex-generated thread IDs are UUIDv7.")
    ]
    model: Annotated[
        str | None,
        Field(
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, kodex exec, kodex app-server, etc.)."
        ),
    ]
