...
/// Runtime operation requested by the model, a JS code cell, or Kodex itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_kodex_turn_id: Option<KodexTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the Kodex tool boundary.
    ///
    ...
    /// they describe how Kodex executed the request, not what the caller sent.
