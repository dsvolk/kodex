...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            StatusSurfacePreviewItem::AppName => "kodex",
            ...
            StatusSurfacePreviewItem::KodexVersion => "0.0.0",
            ...
            StatusSurfacePreviewItem::Model => "gpt-5.2-kodex",
            StatusSurfacePreviewItem::ModelWithReasoning => "gpt-5.2-kodex medium",
