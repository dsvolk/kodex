...
use kodex_protocol::approvals::NetworkApprovalProtocol;
use kodex_protocol::models::AdditionalPermissionProfile;
use kodex_protocol::models::SandboxPermissions;
use kodex_protocol::protocol::GuardianAssessmentOutcome;
use kodex_protocol::protocol::GuardianCommandSource;
use kodex_protocol::protocol::GuardianRiskLevel;
use kodex_protocol::protocol::GuardianUserAuthorization;
use kodex_protocol::protocol::HookEventName;
use kodex_protocol::protocol::HookExecutionMode;
use kodex_protocol::protocol::HookHandlerType;
...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(KodexAppMentionedEventRequest),
    AppUsed(KodexAppUsedEventRequest),
    HookRun(KodexHookRunEventRequest),
    Compaction(Box<KodexCompactionEventRequest>),
    Goal(Box<KodexGoalEventRequest>),
    ThreadHintStatus(Box<crate::thread_hint::ThreadHintStatusEventRequest>),
    TurnEvent(Box<KodexTurnEventRequest>),
    TurnSteer(KodexTurnSteerEventRequest),
    ArtifactOperation(KodexArtifactOperationEventRequest),
    CommandExecution(KodexCommandExecutionEventRequest),
    PluginMeasurement(KodexPluginMeasurementEventRequest),
    FileChange(KodexFileChangeEventRequest),
    McpToolCall(KodexMcpToolCallEventRequest),
    DynamicToolCall(KodexDynamicToolCallEventRequest),
    ControlToolCall(KodexControlToolCallEventRequest),
    CollabAgentToolCall(KodexCollabAgentToolCallEventRequest),
    WebSearch(KodexWebSearchEventRequest),
    ImageGeneration(KodexImageGenerationEventRequest),
    AcceptedLineFingerprints(Box<KodexAcceptedLineFingerprintsEventRequest>),
    #[allow(dead_code)]
    ReviewEvent(KodexReviewEventRequest),
    PluginUsed(KodexPluginUsedEventRequest),
    PluginInstallRequested(KodexPluginInstallRequestedEventRequest),
    PluginInstalled(KodexPluginEventRequest),
    PluginUninstalled(KodexPluginEventRequest),
    PluginEnabled(KodexPluginEventRequest),
    PluginDisabled(KodexPluginEventRequest),
    PluginInstallFailed(KodexPluginInstallFailedEventRequest),
    ExternalAgentConfigImportCompleted(KodexOnboardingExternalAgentImportCompleteEventRequest),
    ExternalAgentConfigImportFailure(KodexOnboardingExternalAgentImportFailureEventRequest),
}

#[derive(Serialize)]
pub(crate) struct KodexArtifactOperationEventParams {
...
#[derive(Serialize)]
pub(crate) struct KodexArtifactOperationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexArtifactOperationEventParams,
}

pub(crate) fn kodex_artifact_operation_event_request(
    tracking: TrackEventsContext,
    operation: ArtifactOperation,
) -> KodexArtifactOperationEventRequest {
    KodexArtifactOperationEventRequest {
        event_type: "kodex_artifact_operation",
        event_params: KodexArtifactOperationEventParams {
...
#[derive(Serialize)]
pub(crate) struct KodexAcceptedLineFingerprintsEventParams {
    pub(crate) event_type: &'static str,
    pub(crate) turn_id: String,
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct KodexAcceptedLineFingerprintsEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexAcceptedLineFingerprintsEventParams,
}
...
pub(crate) struct KodexAppServerClientMetadata {
    pub(crate) product_client_id: String,
...
#[derive(Clone, Serialize)]
pub(crate) struct KodexRuntimeMetadata {
    pub(crate) kodex_rs_version: String,
...
pub(crate) struct ThreadArchiveEventParams {
    ...
    pub(crate) app_server_client: Option<KodexAppServerClientMetadata>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) runtime: Option<KodexRuntimeMetadata>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) thread_source: Option<ThreadSource>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(crate) parent_thread_id: Option<String>,
...
pub enum GuardianApprovalRequestSource {
    /// Approval requested directly by the main Kodex turn.
    MainTurn,
...
#[derive(Serialize)]
pub(crate) struct KodexToolItemEventBase {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct KodexReviewEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct KodexReviewEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexReviewEventParams,
}
#[allow(dead_code)]
#[derive(Clone, Copy, Debug, Serialize)]
#[serde(rename_all = "snake_case")]
...
#[derive(Serialize)]
pub(crate) struct KodexCommandExecutionEventParams {
    pub(crate) model_slug: Option<String>,
    pub(crate) reasoning_effort: Option<String>,
    #[serde(flatten)]
    pub(crate) base: KodexToolItemEventBase,
    pub(crate) plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct KodexCommandExecutionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexCommandExecutionEventParams,
}

#[derive(Serialize)]
pub(crate) struct KodexPluginMeasurementEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    pub(crate) item_id: String,
...
#[derive(Serialize)]
pub(crate) struct KodexPluginMeasurementEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexPluginMeasurementEventParams,
}

#[derive(Serialize)]
pub(crate) struct KodexFileChangeEventParams {
    #[serde(flatten)]
    pub(crate) base: KodexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct KodexFileChangeEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexFileChangeEventParams,
}

#[derive(Serialize)]
pub(crate) struct KodexMcpToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: KodexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct KodexMcpToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexMcpToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct KodexDynamicToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: KodexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct KodexDynamicToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexDynamicToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct KodexControlToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: KodexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct KodexControlToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexControlToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct KodexCollabAgentToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: KodexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct KodexCollabAgentToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexCollabAgentToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct KodexWebSearchEventParams {
    #[serde(flatten)]
    pub(crate) base: KodexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct KodexWebSearchEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexWebSearchEventParams,
}

#[derive(Serialize)]
pub(crate) struct KodexImageGenerationEventParams {
    #[serde(flatten)]
    pub(crate) base: KodexToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct KodexImageGenerationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexImageGenerationEventParams,
}

#[derive(Serialize)]
pub(crate) struct KodexAppMetadata {
    pub(crate) connector_id: Option<String>,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct KodexAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct KodexAppUsedMetadata {
    #[serde(flatten)]
    pub(crate) app: KodexAppMetadata,
    pub(crate) voice_session_id: Option<String>,
    pub(crate) elicitation_type: Option<ElicitationType>,
}

#[derive(Serialize)]
pub(crate) struct KodexAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexAppUsedMetadata,
}

#[derive(Serialize)]
pub(crate) struct KodexHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) product_client_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct KodexHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct KodexCompactionEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    pub(crate) app_server_client: KodexAppServerClientMetadata,
    ...
    pub(crate) kodex_error_kind: Option<KodexErrKind>,
    pub(crate) kodex_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct KodexCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct KodexGoalEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: Option<String>,
    pub(crate) app_server_client: KodexAppServerClientMetadata,
    ...
    pub(crate) goal_status: kodex_state::ThreadGoalStatus,
...
#[derive(Serialize)]
pub(crate) struct KodexGoalEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexGoalEventParams,
}

#[derive(Serialize)]
pub(crate) struct KodexTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    ...
    pub(crate) kodex_turn_source: Option<String>,
    ...
    pub(crate) turn_error: Option<KodexErrorInfo>,
    pub(crate) kodex_error_kind: Option<KodexErrKind>,
    pub(crate) kodex_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct KodexTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct KodexTurnSteerEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
...
#[derive(Serialize)]
pub(crate) struct KodexTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct KodexPluginMetadata {
    pub(crate) plugin_id: Option<String>,
    pub(crate) remote_plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct KodexPluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: KodexPluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct KodexPluginInstallRequestedPluginMetadata {
    pub(crate) plugin_id: String,
    pub(crate) remote_plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct KodexPluginInstallRequestedMetadata {
    pub(crate) suggestion_id: String,
    pub(crate) plugins: Vec<KodexPluginInstallRequestedPluginMetadata>,
...
#[derive(Serialize)]
pub(crate) struct KodexPluginInstallRequestedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexPluginInstallRequestedMetadata,
}

#[derive(Serialize)]
pub(crate) struct KodexPluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexPluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct KodexPluginInstallFailedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: KodexPluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct KodexPluginInstallFailedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexPluginInstallFailedMetadata,
}

#[derive(Serialize)]
pub(crate) struct KodexOnboardingExternalAgentImportCompleteMetadata {
...
#[derive(Serialize)]
pub(crate) struct KodexOnboardingExternalAgentImportCompleteEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexOnboardingExternalAgentImportCompleteMetadata,
}

#[derive(Serialize)]
pub(crate) struct KodexOnboardingExternalAgentImportFailureMetadata {
    pub(crate) import_id: String,
    pub(crate) source: String,
    pub(crate) provider_id: String,
    #[serde(rename = "type")]
...
#[derive(Serialize)]
pub(crate) struct KodexOnboardingExternalAgentImportFailureEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexOnboardingExternalAgentImportFailureMetadata,
}

#[derive(Serialize)]
pub(crate) struct KodexPluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: KodexPluginUsedMetadata,
}

pub(crate) fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "kodex_plugin_installed",
        PluginState::Uninstalled => "kodex_plugin_uninstalled",
        PluginState::Enabled => "kodex_plugin_enabled",
        PluginState::Disabled => "kodex_plugin_disabled",
    }
}

pub(crate) fn kodex_app_metadata(
    tracking: &TrackEventsContext,
    app: AppInvocation,
) -> KodexAppMetadata {
    KodexAppMetadata {
...
pub(crate) fn kodex_plugin_metadata(plugin: PluginTelemetryMetadata) -> KodexPluginMetadata {
    kodex_plugin_metadata_with_product_client_id(plugin, originator().value)
}

fn kodex_plugin_metadata_with_product_client_id(
...
pub(crate) fn kodex_plugin_install_requested_metadata(
    tracking: &TrackEventsContext,
    request: PluginInstallRequested,
) -> KodexPluginInstallRequestedMetadata {
    KodexPluginInstallRequestedMetadata {
        suggestion_id: request.suggestion_id,
        plugins: request
            .plugins
            .into_iter()
            .map(|plugin| KodexPluginInstallRequestedPluginMetadata {
...
pub(crate) fn kodex_compaction_event_params(
    input: KodexCompactionEvent,
    session_id: String,
    ...
    KodexCompactionEventParams {
        ...
        status: input.status,
        kodex_error_kind: input.kodex_error_kind,
        kodex_error_http_status_code: input.kodex_error_http_status_code,
...
pub(crate) fn kodex_goal_event_params(
    input: KodexGoalEvent,
    session_id: String,
    app_server_client: KodexAppServerClientMetadata,
    runtime: KodexRuntimeMetadata,
    thread_source: Option<ThreadSource>,
...
pub(crate) fn kodex_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> KodexPluginUsedMetadata {
    let mcp_server_names = plugin
        .capability_summary
        .as_ref()
        .map(|summary| summary.mcp_server_names.clone());
    KodexPluginUsedMetadata {
        plugin: kodex_plugin_metadata_with_product_client_id(
            plugin,
...
pub(crate) fn kodex_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> KodexHookRunMetadata {
    KodexHookRunMetadata {
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        product_client_id: Some(tracking.product_client_id.clone()),
...
pub(crate) fn current_runtime_metadata() -> KodexRuntimeMetadata {
    let os_info = os_info::get();
    KodexRuntimeMetadata {
        kodex_rs_version: env!("CARGO_PKG_VERSION").to_string(),
