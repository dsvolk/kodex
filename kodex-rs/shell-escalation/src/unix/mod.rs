...
//! `EscalateRequest` over the inherited `KODEX_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `KODEX_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use kodex_protocol::approvals::EscalationPermissions;
pub use kodex_protocol::approvals::ResolvedPermissionProfile;
