...
//! "leave the old title alone" or "clear the title Kodex last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Kodex manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Kodex started managing the title.
