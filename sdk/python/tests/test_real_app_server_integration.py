...
RUN_REAL_KODEX_TESTS = os.environ.get("RUN_REAL_KODEX_TESTS") == "1"
pytestmark = pytest.mark.skipif(
    not RUN_REAL_KODEX_TESTS,
    reason="set RUN_REAL_KODEX_TESTS=1 to run real Kodex integration coverage",
)
...
def runtime_env(tmp_path_factory: pytest.TempPathFactory) -> PreparedRuntimeEnv:
    ...
    env["KODEX_PYTHON_SDK_DIR"] = str(ROOT)
