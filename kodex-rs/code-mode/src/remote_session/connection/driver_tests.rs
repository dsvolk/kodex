...
use kodex_code_mode_protocol::CodeModeSessionCellExecutionLimits;
use kodex_code_mode_protocol::CodeModeSessionDelegate;
use kodex_code_mode_protocol::ExecuteRequest;
use kodex_code_mode_protocol::NotificationFuture;
use kodex_code_mode_protocol::ToolInvocationFuture;
use kodex_code_mode_protocol::WaitRequest;
use kodex_code_mode_protocol::host::CapabilitySet;
use kodex_code_mode_protocol::host::ClientToHost;
use kodex_code_mode_protocol::host::DelegateRequest;
use kodex_code_mode_protocol::host::DelegateRequestId;
use kodex_code_mode_protocol::host::EncodedFrame;
use kodex_code_mode_protocol::host::HostRequest;
use kodex_code_mode_protocol::host::HostResponse;
use kodex_code_mode_protocol::host::HostToClient;
use kodex_code_mode_protocol::host::MAX_PENDING_DELEGATE_CALLS;
use kodex_code_mode_protocol::host::RequestId;
use kodex_code_mode_protocol::host::SessionId;
use kodex_code_mode_protocol::host::WireNestedToolCall;
use kodex_code_mode_protocol::host::WireResult;
use kodex_code_mode_protocol::host::WireRuntimeResponse;
use kodex_code_mode_protocol::host::WireSessionCellExecutionLimits;
use kodex_code_mode_protocol::host::WireWaitOutcome;
...
struct DriverHarness {
    ...
    outgoing_rx: mpsc::Receiver<kodex_code_mode_protocol::host::EncodedFrame>,
...
impl DriverHarness {
    ...
    ) -> kodex_code_mode_protocol::StartedCell {
        let (response_tx, response_rx) = oneshot::channel();
        self.command_tx
            ...
            .send(DriverEvent::HostMessage(HostToClient::DelegateRequest {
                ...
                request: DelegateRequest::InvokeTool {
                    invocation: WireNestedToolCall {
                        ...
                        tool_kind: kodex_code_mode_protocol::CodeModeToolKind::Function.into(),
                        input: None,
                    },
                },
            }))
...
async fn deferred_delegates_follow_cell_readiness_and_cancellation() {
    ...
    assert_eq!(
        ...
        ClientToHost::DelegateResponse {
            ...
            result: WireResult::Ok {
                value: kodex_code_mode_protocol::host::DelegateResponse::NotificationDelivered,
            },
        }
    );
    assert_eq!(
...
async fn terminate_closes_cell_without_waiting_for_delegate_cleanup() {
    ...
    assert_eq!(
        ...
        Ok(kodex_code_mode_protocol::WaitOutcome::LiveCell(
            kodex_code_mode_protocol::RuntimeResponse::Terminated {
...
async fn remote_wait_accepts_durations_longer_than_five_minutes() {
    ...
    assert_eq!(
        ...
        Ok(kodex_code_mode_protocol::WaitOutcome::LiveCell(
            kodex_code_mode_protocol::RuntimeResponse::Yielded {
                code_mode_host_duration: Some(Duration::ZERO),
                cell_id: CellId::new("1".to_string()),
                content_items: Vec::new(),
            }
