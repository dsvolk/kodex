...
use kodex_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use kodex_app_server_protocol::AuthRecoveryNotification;
use kodex_app_server_protocol::CommandAction as V2ParsedCommand;
use kodex_app_server_protocol::CommandExecutionApprovalDecision;
use kodex_app_server_protocol::CommandExecutionPresentation;
use kodex_app_server_protocol::CommandExecutionRequestApprovalParams;
use kodex_app_server_protocol::CommandExecutionRequestApprovalResponse;
...
use kodex_app_server_protocol::DynamicToolCallParams;
use kodex_app_server_protocol::EnvironmentConnectionNotification;
use kodex_app_server_protocol::ErrorNotification;
use kodex_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use kodex_app_server_protocol::FileChangeApprovalDecision;
use kodex_app_server_protocol::FileChangeRequestApprovalParams;
use kodex_app_server_protocol::FileChangeRequestApprovalResponse;
use kodex_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use kodex_app_server_protocol::GuardianWarningNotification;
use kodex_app_server_protocol::HookCompletedNotification;
use kodex_app_server_protocol::HookStartedNotification;
use kodex_app_server_protocol::ItemCompletedNotification;
use kodex_app_server_protocol::ItemStartedNotification;
use kodex_app_server_protocol::KodexErrorInfo as V2KodexErrorInfo;
use kodex_app_server_protocol::McpServerElicitationAction;
use kodex_app_server_protocol::McpServerElicitationRequestParams;
use kodex_app_server_protocol::McpServerElicitationRequestResponse;
use kodex_app_server_protocol::McpServerStartupState;
use kodex_app_server_protocol::McpServerStatusUpdatedNotification;
use kodex_app_server_protocol::ModelReroutedNotification;
use kodex_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use kodex_app_server_protocol::ModelVerificationNotification;
use kodex_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use kodex_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use kodex_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use kodex_app_server_protocol::PermissionsRequestApprovalParams;
use kodex_app_server_protocol::PermissionsRequestApprovalResponse;
use kodex_app_server_protocol::RawResponseCompletedNotification;
use kodex_app_server_protocol::RawResponseItemCompletedNotification;
use kodex_app_server_protocol::RequestId;
use kodex_app_server_protocol::ServerNotification;
use kodex_app_server_protocol::ServerRequestPayload;
use kodex_app_server_protocol::StrictReviewRequiredNotification;
use kodex_app_server_protocol::ThreadGoalUpdatedNotification;
use kodex_app_server_protocol::ThreadItem;
use kodex_app_server_protocol::ThreadRealtimeClosedNotification;
use kodex_app_server_protocol::ThreadRealtimeErrorNotification;
use kodex_app_server_protocol::ThreadRealtimeItemAddedNotification;
use kodex_app_server_protocol::ThreadRealtimeItemCompletedNotification;
use kodex_app_server_protocol::ThreadRealtimeItemStartedNotification;
use kodex_app_server_protocol::ThreadRealtimeItemTranscriptDeltaNotification;
use kodex_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use kodex_app_server_protocol::ThreadRealtimeSdpNotification;
use kodex_app_server_protocol::ThreadRealtimeStartedNotification;
use kodex_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use kodex_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use kodex_app_server_protocol::ThreadSettingsUpdatedNotification;
use kodex_app_server_protocol::ThreadTokenUsage;
use kodex_app_server_protocol::ThreadTokenUsageUpdatedNotification;
...
use kodex_app_server_protocol::ToolRequestUserInputResponse;
use kodex_app_server_protocol::Turn;
use kodex_app_server_protocol::TurnCompletedNotification;
use kodex_app_server_protocol::TurnDiffUpdatedNotification;
...
use kodex_app_server_protocol::TurnModerationMetadataNotification;
use kodex_app_server_protocol::TurnPlanStep;
use kodex_app_server_protocol::TurnPlanUpdatedNotification;
...
use kodex_app_server_protocol::build_item_from_guardian_event;
use kodex_app_server_protocol::guardian_auto_approval_review_notification;
...
use kodex_protocol::items::CollabAgentTool as CoreCollabAgentTool;
use kodex_protocol::items::ModelInvocationContext;
use kodex_protocol::items::TurnItem as CoreTurnItem;
use kodex_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use kodex_protocol::plan_tool::UpdatePlanArgs;
use kodex_protocol::protocol::Event;
use kodex_protocol::protocol::EventMsg;
use kodex_protocol::protocol::ExecApprovalRequestEvent;
...
use kodex_protocol::protocol::TurnDiffEvent;
...
use kodex_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use kodex_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use kodex_shell_command::parse_command::shlex_join;
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error, failure_reason) = match update.status {
                kodex_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None, None)
                }
                kodex_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None, None)
                }
                kodex_protocol::protocol::McpStartupStatus::Failed { error, reason } => (
                    McpServerStartupState::Failed,
                    Some(error),
                    reason.map(Into::into),
                ),
                kodex_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status == kodex_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            if assessment.status == kodex_protocol::protocol::GuardianAssessmentStatus::InProgress
                && matches!(
                    ...
                    Some(
                        kodex_protocol::approvals::GuardianReviewReason::ElevatedRisk
                            | kodex_protocol::approvals::GuardianReviewReason::StaleScore
                            | kodex_protocol::approvals::GuardianReviewReason::IncompatibleCompaction
                            | kodex_protocol::approvals::GuardianReviewReason::ScoringFailure
                            | kodex_protocol::approvals::GuardianReviewReason::AuthorizationChanged
                    )
                )
            {
                outgoing
            ...
            let completion_status = match assessment.status {
                kodex_protocol::protocol::GuardianAssessmentStatus::Denied
                | kodex_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                kodex_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                kodex_protocol::protocol::GuardianAssessmentStatus::InProgress
                | kodex_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
        ...
        EventMsg::ElicitationRequest(request) => {
            let user_verification = matches!(
                &request.request,
                kodex_protocol::approvals::ElicitationRequest::UserVerification { .. }
            );
            let permission_guard = thread_watch_manager
                .note_permission_requested(&conversation_id.to_string())
                .await;
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: kodex_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let turn_error = TurnError {
                ...
                message: ev.message,
                kodex_error_info: ev.kodex_error_info.map(V2KodexErrorInfo::from),
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: kodex_protocol::mcp::RequestId,
    pending_request_id: RequestId,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: kodex_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            kodex_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use kodex_app_server_protocol::AutoReviewDecisionSource;
    ...
    use kodex_app_server_protocol::TurnPlanStepStatus;
    use kodex_login::KodexAuth;
    use kodex_protocol::AgentPath;
    use kodex_protocol::items::AgentMessageContent as CoreAgentMessageContent;
    use kodex_protocol::items::AgentMessageItem as CoreAgentMessageItem;
    use kodex_protocol::items::DynamicToolCallItem;
    use kodex_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
    use kodex_protocol::items::SubAgentActivityItem;
    use kodex_protocol::items::TurnItem as CoreTurnItem;
    use kodex_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use kodex_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    use kodex_protocol::plan_tool::PlanItemArg;
    use kodex_protocol::plan_tool::StepStatus;
    use kodex_protocol::protocol::AuthRecoveryEvent;
    use kodex_protocol::protocol::CreditsSnapshot;
    use kodex_protocol::protocol::EventMsg;
    use kodex_protocol::protocol::GuardianAssessmentEvent;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            started_at: None,
            reason: kodex_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(kodex_protocol::protocol::GuardianRiskLevel::Low),
                Some(kodex_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(kodex_protocol::protocol::GuardianRiskLevel::High),
                Some(kodex_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(kodex_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = kodex_protocol::protocol::GuardianAssessmentAction::Command {
            source: kodex_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: kodex_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: kodex_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(kodex_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(kodex_protocol::protocol::GuardianUserAuthorization::Low),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    kodex_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(kodex_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(kodex_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = kodex_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: kodex_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: kodex_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            kodex_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&kodex_home).await;
        let thread_manager = Arc::new(
            kodex_core::test_support::thread_manager_with_models_provider_and_home(
        ...
        let kodex_core::NewThread {
            ...
            .start_thread(kodex_core::StartThreadOptions::new(config.clone()))
            .await?;
        let thread_state = new_thread_state();
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                kodex_error_info: Some(V2KodexErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(kodex_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(kodex_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(kodex_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    root_turn_id: None,
                    trace_id: None,
                    started_at: Some(42),
    ...
    async fn interrupted_subagent_activity_removes_missing_thread_watch() -> Result<()> {
        ...
        let kodex_core::NewThread {
            ...
            .start_thread(kodex_core::StartThreadOptions::new(config))
            .await?;
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    id: "activity-1".to_string(),
                    kind: kodex_app_server_protocol::SubAgentActivityKind::Interrupted,
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                kodex_error_info: Some(V2KodexErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            ServerNotification::AccountRateLimitsUpdated(payload) => {
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("kodex"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                kodex_error_info: Some(V2KodexErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
