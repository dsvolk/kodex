...
use kodex_guardian_reviewer::ConversationCheckpoint;
use kodex_guardian_reviewer::ConversationState;
use kodex_guardian_reviewer::ReviewModel;
use kodex_guardian_reviewer::ReviewSessionResult;
use kodex_guardian_reviewer::SessionDisposition;
...
use kodex_tools::normalize_output_image_detail;
...
use kodex_guardian_reviewer::run_before_review_deadline;
use kodex_guardian_reviewer::wait_for_guardian_review;

const GUARDIAN_MAX_IMAGE_ITEM_TOKENS: i64 = 10_000;
pub(crate) use kodex_guardian_reviewer::GuardianReviewSessionOutcome;
...
pub(crate) type GuardianReviewSessionManager =
    kodex_guardian_reviewer::ReviewerPool<GuardianReviewSession>;
...
pub struct GuardianReviewSessionReuseKey {
    ...
    root_authorization_version: Option<crate::kodex_thread::GuardianAuthorizationVersion>,
...
impl GuardianReviewSessionReuseKey {
    fn from_spawn_config(
        ...
        Self {
            ...
            kodex_linux_sandbox_exe: spawn_config.kodex_linux_sandbox_exe.clone(),
...
async fn run_review_on_session(
    ...
    let parent_turn_environments = params
        ...
        .map(|environment| {
            ...
            selection.config = kodex_protocol::protocol::EnvironmentConfigState::Ready(
    ...
    let request = kodex_guardian_reviewer::ReviewerTurn {
        items,
        environments: kodex_protocol::protocol::TurnEnvironmentSelections::new(
    ...
    .into_request();
    let child_turn_id = match kodex_guardian_reviewer::start_review_turn(
        review_session,
        request,
        deadline,
        params.external_cancel.as_ref(),
    ...
    let result = match turn_result.outcome {
        GuardianReviewSessionOutcome::SessionFailed {
            error_info: Some(KodexErrorInfo::ContextWindowExceeded),
            ..
        } if matches!(
...
impl kodex_guardian_reviewer::ReviewerRuntime for GuardianReviewSession {
...
impl kodex_guardian_reviewer::ReviewerSession for GuardianReviewSession {
