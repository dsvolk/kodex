...
use anyhow::Result;
use kodex_app_server_protocol as rpc;
...
async fn user_verification_initialize_owns_advertisement_and_eligibility() -> Result<()> {
    for (origin, name, opt_in, supported, expected) in [
        (ConnectionOrigin::InProcess, "kodex-tui", true, true, true),
        (ConnectionOrigin::WebSocket, "kodex-tui", true, true, false),
        (
        ...
        (ConnectionOrigin::Stdio, "kodex-tui", true, true, false),
        (ConnectionOrigin::InProcess, "other-ui", true, true, false),
        (ConnectionOrigin::InProcess, "kodex-tui", false, true, false),
        (ConnectionOrigin::InProcess, "kodex-tui", true, false, false),
        (ConnectionOrigin::Stdio, "Kodex Desktop", true, true, true),
        (
        ...
        (ConnectionOrigin::Stdio, "kodex_desktop", true, true, false),
        (ConnectionOrigin::Stdio, "Kodex Desktop", false, true, false),
        (ConnectionOrigin::Stdio, "Kodex Desktop", true, false, false),
    ] {
        ...
        let thread_id = kodex_protocol::ThreadId::new();
        let (id, response) = h
            .outgoing
