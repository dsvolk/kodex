        ...
        tracing_subscriber::fmt::layer()
            ...
            .with_filter(
                tracing_subscriber::filter::Targets::new()
                    .with_target("kodex_http_client::transport", tracing::Level::TRACE)
                    .with_target("kodex_http_client::client", tracing::Level::DEBUG),
            ),
    );
    let _guard = tracing::subscriber::set_default(subscriber);
    tracing::trace!(target: "kodex_http_client::transport", "log capture sentinel");
