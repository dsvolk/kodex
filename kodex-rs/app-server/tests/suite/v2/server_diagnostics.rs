...
use kodex_app_server_protocol::ServerDiagnosticsGauge;
use kodex_app_server_protocol::ServerDiagnosticsParams;
use kodex_app_server_protocol::ServerDiagnosticsResponse;
