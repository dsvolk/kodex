...
use kodex_mcp::McpEventNotification;
...
impl Fixture {
    pub async fn new() -> Result<Self> {
        ...
        let auth_value = KodexAuth::from_external_chatgpt_tokens(
            "header.e30.first",
            "account",
        ...
        let mut server_config = kodex_mcp::hosted_plugin_runtime_mcp_server_config(
        ...
        *bearer_token_env_var = None;
        ...
        let runtime_input = || McpRuntimeInput {
            ...
            mcp_servers: HashMap::from([(
                KODEX_APPS_MCP_SERVER_NAME.into(),
            ...
            kodex_apps_tools_cache: Default::default(),
            tool_catalog_cache: Default::default(),
            kodex_apps_tools_cache_key: kodex_mcp::kodex_apps_tools_cache_key(Some(&auth_value)),
        ...
        assert!(
            runtime
                .latest_wait_for_server_ready(KODEX_APPS_MCP_SERVER_NAME, WAIT)
                .await
        );
        Ok(Self {
            _home: home,
...
pub(super) struct StaticAuth(pub KodexAuth);
