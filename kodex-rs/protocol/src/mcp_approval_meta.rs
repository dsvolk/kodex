/// Identifies privileged Kodex approvals. Changing this key or adding another
/// privileged discriminator requires updating the MCP elicitation router's
/// form-forwarding safeguards.
pub const APPROVAL_KIND_KEY: &str = "kodex_approval_kind";
...
pub const REQUIRES_USER_INPUT_KEY: &str = "kodex_requires_user_input";
pub const REQUEST_TYPE_KEY: &str = "kodex_request_type";
pub const REQUEST_TYPE_APPROVAL_REQUEST: &str = "approval_request";
pub const STRICT_AUTO_REVIEW_KEY: &str = "kodex_strict_auto_review";
...
pub const SENSITIVE_ACTION_KEY: &str = "kodex_sensitive_action";
