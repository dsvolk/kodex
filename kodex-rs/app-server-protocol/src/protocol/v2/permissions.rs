...
use crate::TS;
use kodex_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use kodex_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use kodex_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use kodex_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use kodex_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use kodex_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use kodex_protocol::models::LegacyReadWriteRoots;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> kodex_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<kodex_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: kodex_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            kodex_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            kodex_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            kodex_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
