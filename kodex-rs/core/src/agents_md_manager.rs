...
use kodex_utils_string::approx_tokens_from_byte_count;
use std::sync::Arc;
...
impl AgentsMdManager {
    ...
    ) -> (KodexResult<Option<Arc<LoadedAgentsMd>>>, Vec<String>) {
...
fn validate_thread_instruction_size(bytes: usize) -> KodexResult<()> {
