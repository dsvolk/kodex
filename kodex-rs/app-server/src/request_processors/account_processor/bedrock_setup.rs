...
use kodex_app_server_protocol::AwsCredentialType;
use kodex_app_server_protocol::BedrockAwsProfile;
use kodex_app_server_protocol::BedrockDiscoverParams;
use kodex_app_server_protocol::BedrockDiscoverResponse;
use kodex_app_server_protocol::BedrockEnvironmentCredential;
...
impl AccountRequestProcessor {
    pub(crate) async fn bedrock_discover(
        ...
        let profiles = kodex_aws_auth::discover_aws_profiles()
            .await
