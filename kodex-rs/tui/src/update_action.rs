...
pub enum UpdateAction {
    ...
    /// Update via `npm install -g @openai/kodex@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @openai/kodex@latest`.
    BunGlobalLatest,
    /// Update via `vp install -g @openai/kodex@latest`.
    ...
    StandaloneUnix,
    /// Update via `$env:KODEX_NON_INTERACTIVE=1; irm https://chatgpt.com/kodex/install.ps1 | iex`.
    StandaloneWindows,
}
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::Daemon(source) => ("kodex", source.command_args()),
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "@openai/kodex"]),
            ...
            UpdateAction::StandaloneUnix => (
                ...
                &[
                    "-c",
                    "curl -fsSL https://chatgpt.com/kodex/install.sh | KODEX_NON_INTERACTIVE=1 sh",
                ],
            ),
            UpdateAction::StandaloneWindows => (
                ...
                &[
                    ...
                    "Bypass",
                    "-c",
                    "$env:KODEX_NON_INTERACTIVE=1; irm https://chatgpt.com/kodex/install.ps1 | iex",
                ],
            ),
        }
    }
        ...
        assert_eq!(
            UpdateAction::from_install_context(&InstallContext {
                method: InstallMethod::Standalone {
                    ...
                    resources_dir: Some(native_release_dir.join("kodex-resources")),
                },
                package_layout: None,
            }),
