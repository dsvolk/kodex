...
pub enum ApprovalDecision {
    ...
    Allow,
    Reviewed(kodex_protocol::protocol::ReviewDecision),
    AskUser,
}
...
pub trait SynchronousApprovalReviewer: Send + Sync {
    fn review(
        &self,
        reason: kodex_protocol::approvals::GuardianReviewReason,
    ) -> crate::ExtensionFuture<'_, Option<kodex_protocol::protocol::ReviewDecision>>;
}
...
pub struct ApprovalDecisionInput<'a> {
    ...
    pub category: kodex_protocol::openai_models::GuardianScope,
    pub approval_policy: kodex_protocol::protocol::AskForApproval,
    pub approvals_reviewer: kodex_protocol::config_types::ApprovalsReviewer,
