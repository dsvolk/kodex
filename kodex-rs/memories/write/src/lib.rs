//! Write-path implementation for Kodex memories.
//!
...
mod guard_limits {
    pub(super) const KODEX_LIMIT_ID: &str = "kodex";
}
...
mod stage_one {
    pub(super) const REASONING_EFFORT: kodex_protocol::openai_models::ReasoningEffort =
        kodex_protocol::openai_models::ReasoningEffort::Low;
