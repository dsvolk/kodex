...
pub struct ResponseItemEnvelope {
    ...
    pub metadata: Option<KodexHarnessMetadata>,
}

/// Metadata owned by the Kodex harness and persisted with a response item.
///
#[derive(Serialize, Deserialize, Debug, Clone, Default, PartialEq, Eq, JsonSchema)]
pub struct KodexHarnessMetadata {
    ...
    /// Whether a response configuration update was created by the Kodex harness itself.
...
/// kodex_rollout's canonical parser so nested decimal values survive the flattened envelope.
