...
pub enum ConfigLayerSource {
    /// Default configuration supplied with the installed Kodex package.
    ...
    /// User config layer from $KODEX_HOME/config.toml. This layer is special
    ...
    /// Path to a .kodex/ folder within a project. There could be multiple of
