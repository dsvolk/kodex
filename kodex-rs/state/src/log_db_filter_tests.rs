...
async fn sqlite_sink_filters_noisy_targets_without_dropping_useful_diagnostics() {
    let kodex_home =
        std::env::temp_dir().join(format!("kodex-state-log-db-filter-{}", Uuid::new_v4()));
    let _cleanup = scopeguard::guard(kodex_home.clone(), |kodex_home| {
        let _ = std::fs::remove_dir_all(kodex_home);
    });
    ...
    tracing::debug!(
        target: "kodex_rmcp_client::oauth",
        "dropped-kodex-rmcp-client-debug"
    );
    tracing::info!(
        target: "kodex_rmcp_client::oauth",
        "retained-kodex-rmcp-client-info"
    );
    tracing::trace!(target: "kodex_http_client::transport", "dropped-request-body");
    tracing::debug!(target: "kodex_http_client::transport", "retained-request-diagnostic");
    tracing::trace!(target: "kodex_api::sse", "dropped-sse-parent");
    tracing::trace!(target: "kodex_api::sse::responses", "dropped-sse-payload");
    tracing::debug!(target: "kodex_api::sse::responses", "retained-sse-diagnostic");
    tracing::trace!(target: "kodex_state", "retained-trace");
    tracing::trace!(
        target: "kodex_tui::streaming::controller",
    ...
    tracing::trace!(
        target: "kodex_tui::streaming::table_holdback",
    ...
    tracing::trace!(
        target: "kodex_tui::streaming::commit_tick",
        "retained-commit-tick-trace"
    );
    tracing::trace!(
        target: "kodex_api::responses_websocket_timing",
    ...
    assert_eq!(
        ...
        vec![
            ...
            (
                "INFO",
                "kodex_rmcp_client::oauth",
                Some("retained-kodex-rmcp-client-info")
            ),
            (
                "DEBUG",
                "kodex_http_client::transport",
                Some("retained-request-diagnostic")
            ),
            (
                "DEBUG",
                "kodex_api::sse::responses",
                Some("retained-sse-diagnostic")
            ),
            ("TRACE", "kodex_state", Some("retained-trace")),
            (
                "DEBUG",
                "kodex_tui::streaming::controller",
                Some("retained-controller-debug"),
            ),
            (
                "DEBUG",
                "kodex_tui::streaming::table_holdback",
                Some("retained-table-holdback-debug"),
            ),
            (
                "TRACE",
                "kodex_tui::streaming::commit_tick",
