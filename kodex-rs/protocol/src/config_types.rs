...
/// Limit for the text included in `kodex.tool_result` log records.
...
/// Validated plain profile-v2 name used to select `$KODEX_HOME/<name>.config.toml`.
...
/// Collaboration mode for a Kodex session.
