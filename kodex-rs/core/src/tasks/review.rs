...
use kodex_prompts::render_review_exit_interrupted;
...
use kodex_protocol::review_format::format_review_findings_block;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        session
            .services
            .session_telemetry
            .counter("kodex.task.review", /*inc*/ 1, &[]);
        ...
        // Start sub-kodex conversation and get the receiver for events.
