...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for Kodex",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit Kodex",
            ...
            SlashCommand::Skills => "use skills to improve how Kodex performs specific tasks",
            ...
            SlashCommand::Permissions => "choose what Kodex is allowed to do",
            ...
            SlashCommand::Logout => "log out of Kodex",
