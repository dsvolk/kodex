...
pub(crate) fn spawn_approval_decision(
    ...
    let spawn_result = std::thread::Builder::new()
        .name("kodex-approval-review".to_string())
...
pub(crate) async fn decide_approval(
    ...
    let require_guardian = options.require_guardian
        ...
        || requirements
            .approvals_reviewer
            .can_set(&kodex_protocol::config_types::ApprovalsReviewer::User)
            .is_err();
    ...
    let decision = kodex_guardian_reviewer::ReviewRequest {
        host: ReviewRuntime {
        ...
        model_requires_review,
        async_enabled: turn.config.features.enabled(kodex_features::Feature::GuardianV2),
        retried,
