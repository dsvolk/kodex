...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: kodex_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, kodex_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                kodex_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                kodex_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                kodex_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                kodex_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                kodex_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                kodex_app_server_protocol::GuardianRiskLevel::Low => {
                    kodex_protocol::approvals::GuardianRiskLevel::Low
                }
                kodex_app_server_protocol::GuardianRiskLevel::Medium => {
                    kodex_protocol::approvals::GuardianRiskLevel::Medium
                }
                kodex_app_server_protocol::GuardianRiskLevel::High => {
                    kodex_protocol::approvals::GuardianRiskLevel::High
                }
                kodex_app_server_protocol::GuardianRiskLevel::Critical => {
                    kodex_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    kodex_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        kodex_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    kodex_app_server_protocol::GuardianUserAuthorization::Low => {
                        kodex_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    kodex_app_server_protocol::GuardianUserAuthorization::Medium => {
                        kodex_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    kodex_app_server_protocol::GuardianUserAuthorization::High => {
                        kodex_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                kodex_app_server_protocol::AutoReviewDecisionSource::Agent => {
