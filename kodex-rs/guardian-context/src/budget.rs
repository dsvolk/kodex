...
pub const SECTION_COST_METRIC: &str = "kodex.guardian.context.section_cost";
pub const REQUEST_TOKENS_METRIC: &str = "kodex.guardian.context.request_tokens";
...
pub fn effective_input_token_limit(
    model: &kodex_protocol::openai_models::ModelInfo,
