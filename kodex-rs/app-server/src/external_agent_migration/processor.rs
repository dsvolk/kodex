...
use kodex_analytics::ExternalAgentConfigImportCompletedInput;
use kodex_analytics::ExternalAgentConfigImportFailureInput;
...
use kodex_app_server_protocol::ExternalAgentConfigImportHistoryRecordParams;
use kodex_app_server_protocol::ExternalAgentConfigImportHistoryRecordResponse;
use kodex_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
use kodex_app_server_protocol::ExternalAgentConfigImportItemTypeSuccess as ProtocolImportSuccess;
...
use kodex_app_server_protocol::ExternalAgentConfigImportTypeResult as ProtocolImportTypeResult;
...
use kodex_external_agent_migration::DetectedConnectorCandidate;
use kodex_external_agent_migration::ExternalAgentConfigDetectOptions;
use kodex_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use kodex_external_agent_migration::ExternalAgentConfigImportOutcome as CoreImportOutcome;
use kodex_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use kodex_external_agent_migration::ExternalAgentConfigService;
use kodex_external_agent_migration::ExternalAgentSessionImportLimits;
use kodex_external_agent_migration::PluginImportOutcome;
use kodex_external_agent_migration::record_import_error;
use kodex_external_agent_migration::sessions::ExternalAgentSessionMigration as CoreSessionMigration;
use kodex_external_agent_migration::sessions::read_imported_connector_candidates;
use kodex_external_agent_migration::sessions::record_detected_session_connectors;
use kodex_features::Feature;
use kodex_rollout::StateDbHandle;
use kodex_state::ExternalAgentConfigImportFailureRecord;
use kodex_state::ExternalAgentConfigImportSuccessRecord;
...
impl ExternalAgentConfigRequestProcessor {
    ...
    pub(crate) async fn detect(
        ...
        record_detected_session_connectors(
            self.migration_service.kodex_home(),
    ...
    pub(crate) async fn read_import_histories(
        ...
        let connectors = read_imported_connector_candidates(self.migration_service.kodex_home())
            .map_err(|err| {
                internal_error(format!(
