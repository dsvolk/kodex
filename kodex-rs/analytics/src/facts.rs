...
/// Measurements for one successfully decoded image at the point where Kodex prepares it for
...
#[derive(Clone)]
pub struct TurnKodexErrorFact {
    pub(crate) turn_id: String,
    pub(crate) thread_id: String,
    pub(crate) error: TurnKodexError,
}

impl TurnKodexErrorFact {
    pub fn from_kodex_err(thread_id: String, turn_id: String, error: &KodexErr) -> Self {
        Self {
            turn_id,
            thread_id,
            error: TurnKodexError::from_kodex_err(error),
        }
    }
}
...
impl TurnKodexError {
    fn from_kodex_err(error: &KodexErr) -> Self {
        Self {
            kind: error.into(),
...
#[derive(Clone)]
pub struct KodexTurnSteerEvent {
...
#[derive(Clone)]
pub struct KodexCompactionEvent {
    pub thread_id: String,
    pub turn_id: String,
...
#[derive(Clone)]
pub struct KodexGoalEvent {
    pub thread_id: String,
    pub turn_id: Option<String>,
    pub goal_id: String,
    pub event_kind: GoalEventKind,
    pub goal_status: kodex_state::ThreadGoalStatus,
...
pub(crate) enum CustomAnalyticsFact {
    ...
    Compaction(Box<KodexCompactionEvent>),
    Goal(Box<KodexGoalEvent>),
    ...
    TurnKodexError(Box<TurnKodexErrorFact>),
