...
use kodex_network_proxy::BlockedRequest;
...
use kodex_network_proxy::NetworkRequestDisconnect;
...
use kodex_sandboxing::record_network_sandbox_violation;
...
pub(crate) async fn begin_network_approval(
    ...
    let execution_proxy = network
        ...
        .map_err(|err| {
            ToolError::Kodex(kodex_protocol::error::KodexErr::Io(io::Error::other(
