...
impl AppsRequestProcessor {
    ...
    async fn apps_list_task(
        ...
        let should_retry = result
            .as_ref()
            .is_ok_and(|(_, kodex_apps_ready)| !kodex_apps_ready);
        outgoing
        ...
        if should_retry && !retry_params.force_refetch {
            ...
            .await
            {
                warn!("failed to refresh app list after kodex-apps readiness retry: {err:?}");
            }
        }
    }
        ...
        loop {
            ...
            match result {
                AppListLoadResult::Accessible(Ok(status)) => {
                    ...
                    kodex_apps_ready = status.kodex_apps_ready;
                }
            ...
            if accessible_loaded && all_loaded {
                ...
                return Ok((response, kodex_apps_ready));
            }
        }
    }
...
const APPS_INSTALLED_DURATION_METRIC: &str = "kodex.apps.installed.duration_ms";
