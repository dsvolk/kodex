# Native voice libraries in Kodex releases

Kodex release packages with voice include dynamically linked GStreamer and GLib
...
projection and package scripts are in the public Kodex source tree under
...
App-local runtime security updates must be delivered with Kodex updates.
