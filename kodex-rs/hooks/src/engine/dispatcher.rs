...
pub(crate) fn completed_summary(
    ...
    entries: Vec<kodex_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    let HandlerSourcePath::Local(source_path) = &handler.source_path else {
        unreachable!("executor-scoped hooks do not produce public hook summaries");
    };
...
pub(crate) fn hook_source_label(source: kodex_protocol::protocol::HookSource) -> &'static str {
    match source {
        kodex_protocol::protocol::HookSource::System => "system",
        kodex_protocol::protocol::HookSource::User => "user",
        kodex_protocol::protocol::HookSource::Project => "project",
        kodex_protocol::protocol::HookSource::Mdm => "mdm",
        kodex_protocol::protocol::HookSource::SessionFlags => "session_flags",
        kodex_protocol::protocol::HookSource::Plugin => "plugin",
        kodex_protocol::protocol::HookSource::CloudRequirements => "cloud_requirements",
        kodex_protocol::protocol::HookSource::CloudManagedConfig => "cloud_managed_config",
        kodex_protocol::protocol::HookSource::LegacyManagedConfigFile => {
            "legacy_managed_config_file"
        }
        kodex_protocol::protocol::HookSource::LegacyManagedConfigMdm => "legacy_managed_config_mdm",
        kodex_protocol::protocol::HookSource::Unknown => "unknown",
    }
}
