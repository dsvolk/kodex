//! Purely omits checklist-tool guidance from Kodex-owned prompts, before adding caller text.

/// Call only for Kodex-owned prompt text; custom instructions must remain unchanged.
