...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        kodex_home: PathBuf::from(r"C:\Users\kodex"),
        cwd: PathBuf::from(r"C:\workspace"),
        env_map: env_map.clone(),
        logs_base_dir: Some(PathBuf::from(r"C:\Users\kodex\.sandbox")),
        spawn_request: SpawnRequest {
            ...
            kodex_home: PathBuf::from(r"C:\Users\kodex\.sandbox"),
            real_kodex_home: PathBuf::from(r"C:\Users\kodex"),
        ...
        deny_write_paths_override: vec![PathBuf::from(r"C:\workspace\.kodex")],
        proxy_enforced: true,
    ...
    let expected_refresh = RefreshObservation {
        ...
        env_map,
        kodex_home: request.kodex_home.clone(),
    ...
    let result = spawn_runner_transport_with_retry(
        ...
        &request,
        |kodex_home, cwd, sandbox_creds, logs_base_dir, spawn_request| {
