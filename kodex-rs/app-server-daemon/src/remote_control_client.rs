...
use kodex_app_server_protocol::RemoteControlDisableParams;
use kodex_app_server_protocol::RemoteControlDisableResponse;
use kodex_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<kodex_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_KODEX_HOME: &str = "/tmp/kodex-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "kodex_app_server/1.2.3",
                    "kodexHome": TEST_KODEX_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),
