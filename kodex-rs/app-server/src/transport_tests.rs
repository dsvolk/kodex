    ...
    route_outgoing_envelope(
        ...
        OutgoingEnvelope::ToConnection {
            ...
            message: OutgoingMessage::Request(ServerRequest::CommandExecutionRequestApproval {
                ...
                params: kodex_app_server_protocol::CommandExecutionRequestApprovalParams {
                    ...
                    additional_permissions: Some(
                        kodex_app_server_protocol::AdditionalPermissionProfile {
                            network: None,
                            file_system: Some(
                                kodex_app_server_protocol::AdditionalFileSystemPermissions {
