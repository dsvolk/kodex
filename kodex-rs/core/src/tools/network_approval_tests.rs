...
async fn execution_cancellation_respects_network_approval_boundary(
        ...
        .new_turn_with_sub_id(
            ...
            crate::session::SessionSettingsUpdate {
                step_settings: crate::session::step_settings::StepSettingsUpdate {
                    ...
                    approvals_reviewer: Some(kodex_config::types::ApprovalsReviewer::User),
                    ..Default::default()
                },
                ..Default::default()
            },
    ...
    session
        .abort_all_tasks(kodex_protocol::protocol::TurnAbortReason::Interrupted)
        .await;
}
...
fn approval_denial_messages_are_bounded_for_model_context() {
    ...
    assert!(kodex_utils_string::approx_token_count(&message) < 1_000);
