...
#[ctor]
pub static KODEX_ALIASES_TEMP_DIR: Option<TestBinaryDispatchGuard> = {
    configure_test_binary_dispatch("kodex-core-tests", |exe_name, argv1| {
        if argv1 == Some(KODEX_CORE_APPLY_PATCH_ARG1) {
