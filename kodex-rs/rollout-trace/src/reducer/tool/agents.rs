...
use anyhow::Result;
use anyhow::bail;
use kodex_protocol::protocol::CollabAgentInteractionBeginEvent;
use kodex_protocol::protocol::CollabAgentInteractionEndEvent;
use kodex_protocol::protocol::CollabAgentSpawnEndEvent;
use kodex_protocol::protocol::CollabCloseBeginEvent;
use kodex_protocol::protocol::CollabCloseEndEvent;
...
pub(in crate::reducer) struct ObservedAgentResultEdge {
    ...
    pub(in crate::reducer) child_kodex_turn_id: String,
        ...
        self.rollout
            ...
            .filter(|item| {
                item.thread_id == thread_id
                    && item.kodex_turn_id.as_deref() == Some(kodex_turn_id)
