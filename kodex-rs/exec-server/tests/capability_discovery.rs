...
use kodex_exec_server::CapabilityRootsDiscoverResponse;
...
use kodex_exec_server_protocol::EXEC_METHOD;
#[cfg(unix)]
use kodex_exec_server_protocol::EXEC_READ_METHOD;
use kodex_exec_server_protocol::FS_OPEN_METHOD;
#[cfg(unix)]
use kodex_exec_server_protocol::FS_READ_BLOCK_METHOD;
use kodex_exec_server_protocol::FS_READ_FILE_METHOD;
#[cfg(unix)]
use kodex_exec_server_protocol::FsReadBlockResponse;
use kodex_exec_server_protocol::FsReadFileResponse;
use kodex_exec_server_protocol::JSONRPCMessage;
use kodex_exec_server_protocol::JSONRPCResponse;
#[cfg(unix)]
use kodex_exec_server_protocol::ReadResponse;
...
async fn discovers_a_complete_capability_bundle_in_one_request() -> anyhow::Result<()> {
  ...
  "apps": "./config/apps.json"
    ...
    assert_eq!(
        ...
        root_uri.join(".kodex-plugin/plugin.json")?
    );
