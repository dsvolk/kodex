...
pub(crate) fn accent_style() -> Style {
    if matches!(
        ...
        crate::render::highlight::foreground_style_for_scopes(&["kodex.accent"])
    {
...
mod tests {
    ...
    fn theme_accents_respect_terminal_color_depth() {
        const CHILD: &str = "KODEX_ACCENT_COLOR_TEST_CHILD";
        ...
        let theme =
            crate::render::highlight::resolve_theme_by_name("ada", /*kodex_home*/ None).unwrap();
