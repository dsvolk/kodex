...
impl PidBackend {
    ...
    pub(crate) fn new(kodex_bin: PathBuf, pid_file: PathBuf, remote_control_enabled: bool) -> Self {
            ...
            let process = {
                ...
                match self.command_kind {
                    PidCommandKind::AppServer { .. } => {
                        ...
                        let socket_path =
                            kodex_app_server_transport::app_server_control_socket_path(kodex_home)?;
                        if let Err(err) =
