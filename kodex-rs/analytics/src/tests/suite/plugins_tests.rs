...
fn plugin_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::PluginUsed(KodexPluginUsedEventRequest {
        event_type: "kodex_plugin_used",
        event_params: kodex_plugin_used_metadata(&tracking, sample_plugin_metadata()),
    });
...
fn plugin_management_event_serializes_expected_shape() {
    let event = TrackEventRequest::PluginInstalled(KodexPluginEventRequest {
        event_type: "kodex_plugin_installed",
        event_params: kodex_plugin_metadata(sample_plugin_metadata()),
    });
...
fn plugin_install_failed_event_serializes_expected_shape() {
    let event = TrackEventRequest::PluginInstallFailed(KodexPluginInstallFailedEventRequest {
        event_type: "kodex_plugin_install_failed",
        event_params: KodexPluginInstallFailedMetadata {
            plugin: kodex_plugin_metadata(sample_plugin_metadata()),
...
async fn reducer_ingests_plugin_state_changed_fact() {
    ...
    assert_eq!(
        payload,
        json!([{
            "event_type": "kodex_plugin_disabled",
            "event_params": {
                "plugin_id": "sample@test",
                "remote_plugin_id": null,
                "plugin_name": "sample",
