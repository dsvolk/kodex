...
use kodex_extension_api::SelectedPluginIdentity;
...
use kodex_mcp::McpEnvironmentAuthority;
...
use kodex_mcp::configured_mcp_servers;
...
const LEGACY_KODEX_APPS_REGISTRATION_ID: &str = "legacy_kodex_apps";
...
impl McpManager {
    ...
    pub fn kodex_apps_tools_cache(&self) -> ConnectorRuntimeManager<ToolInfo> {
        self.kodex_apps_tools_cache.clone()
    }
    ...
    async fn runtime_config_with_context(
        ...
        if mcp_config.apps_enabled {
            catalog.register(McpServerRegistration::from_compatibility(
                ...
                LEGACY_KODEX_APPS_REGISTRATION_ID,
