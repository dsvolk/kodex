...
use anyhow::Context;
use anyhow::Result;
pub(crate) use kodex_windows_sandbox::CORE_INSTALLATION_KEY;
pub(crate) use kodex_windows_sandbox::DesktopInstallation;
pub(crate) use kodex_windows_sandbox::INSTALLATION_KEY;
pub(crate) use kodex_windows_sandbox::INSTALLATION_VALUE;
pub(crate) use kodex_windows_sandbox::InstallationRecord;
pub(crate) use kodex_windows_sandbox::RuntimeAccountRegistration;
pub(crate) use kodex_windows_sandbox::RuntimeRegistration;
pub(crate) use kodex_windows_sandbox::load_installation as load;
pub(crate) use kodex_windows_sandbox::remove_installation as remove;
pub(crate) use kodex_windows_sandbox::save_installation as save_runtime;
use kodex_windows_sandbox::validate_local_directory_path;
...
pub(crate) fn read_desktop_installation(
    ...
    Ok(DesktopInstallation {
        created_kodex_home: home.join(DESKTOP_INSTALLATION_MARKER).is_file(),
        cache_home,
    })
}
