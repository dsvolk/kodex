...
pub enum Feature {
    ...
    /// Requires every reader of the Kodex home to support compressed shared histories.
    ...
    Chronicle,
    /// Compress request bodies (zstd) when sending streaming requests to kodex-backend.
    ...
    Worktrees,
    /// Respect host system proxy settings for Kodex-owned network clients.
    RespectSystemProxy,
    ...
    Mcp20260728,
    /// Enable MCP protocol version 2026-07-28 for the host-owned Kodex Apps server.
    KodexAppsMcp20260728,
    ...
    /// Prompt Kodex Apps connector auth failures through MCP URL elicitations.
    AuthElicitation,
    ...
    match feature {
        ...
        _ => {
            ...
            let details = if alias == canonical {
                ...
                Some(format!(
                    "Enable it with `--enable {canonical}` or `[features].{canonical}` in config.toml. See https://developers.openai.com/kodex/config-basic#feature-flags for details."
                ))
            };
            (summary, details)
        }
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        id: Feature::KodexGitCommit,
        key: "kodex_git_commit",
        stage: Stage::Removed,
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: Network proxy can now be enabled from /experimental. Restart Kodex after enabling it.",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        id: Feature::KodexAppsMcp20260728,
        key: "kodex_apps_mcp_2026_07_28",
        stage: Stage::UnderDevelopment,
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: if cfg!(any(
            ...
            Stage::Experimental {
                ...
                menu_description: "Keep your computer awake while Kodex is running a thread.",
