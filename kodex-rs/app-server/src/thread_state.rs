...
use kodex_app_server_protocol::ThreadHistoryTurnMetadata;
...
use kodex_file_watcher::WatchRegistration;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: kodex_app_server_protocol::Thread,
    ...
    pub(crate) initial_turns_page:
        Option<kodex_app_server_protocol::ThreadResumeInitialTurnsPageParams>,
    pub(crate) paginated_turns: Option<Vec<Turn>>,
    pub(crate) paginated_initial_turns_page: Option<kodex_app_server_protocol::TurnsPage>,
    pub(crate) paginated_initial_turns_page_with_active_slot:
        Option<kodex_app_server_protocol::TurnsPage>,
    pub(crate) resume_cursor_store: Option<Arc<dyn kodex_thread_store::ThreadStore>>,
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<KodexThread>>,
    watch_registration: WatchRegistration,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<KodexThread>) -> bool {
