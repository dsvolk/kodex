use kodex_app_server_protocol::AppBranding as ApiAppBranding;
use kodex_app_server_protocol::AppInfo as ApiAppInfo;
use kodex_app_server_protocol::AppMetadata as ApiAppMetadata;
use kodex_app_server_protocol::AppReview as ApiAppReview;
use kodex_app_server_protocol::AppScreenshot as ApiAppScreenshot;
use kodex_app_server_protocol::AppToolSummary as ApiAppToolSummary;
use kodex_app_server_protocol::ConnectorMetadata as ApiConnectorMetadata;
use kodex_connectors::AppBranding;
use kodex_connectors::AppInfo;
use kodex_connectors::AppMetadata;
use kodex_connectors::AppReview;
use kodex_connectors::AppScreenshot;
...
/// Converts connector-domain app metadata owned by `kodex-connectors` into the app-server wire
/// type owned by `kodex-app-server-protocol`.
///
