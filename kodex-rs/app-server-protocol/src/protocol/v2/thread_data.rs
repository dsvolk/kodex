...
use kodex_protocol::protocol::MisalignmentErrorDetails as CoreMisalignmentErrorDetails;
use kodex_protocol::protocol::MisalignmentSteer as CoreMisalignmentSteer;
use kodex_protocol::protocol::SessionSource as CoreSessionSource;
use kodex_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use kodex_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
...
#[ts(export_to = "v2/")]
pub struct Thread {
    /// Identifier for this thread. Kodex-generated thread IDs are UUIDv7.
    pub id: String,
    ...
    /// Origin of the thread (CLI, VSCode, kodex exec, kodex app-server, etc.).
...
#[ts(export_to = "v2/")]
pub struct Turn {
    /// Identifier for this turn. Kodex-generated turn IDs are UUIDv7.
    pub id: String,
