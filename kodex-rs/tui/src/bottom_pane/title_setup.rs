...
impl TerminalTitleItem {
    pub(crate) fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "Kodex app name",
            ...
            TerminalTitleItem::KodexVersion => "Kodex application version",
    ...
    pub(crate) fn preview_item(self) -> Option<StatusSurfacePreviewItem> {
        match self {
            ...
            TerminalTitleItem::KodexVersion => Some(StatusSurfacePreviewItem::KodexVersion),
    ...
    fn parse_terminal_title_items_accepts_kebab_case_variants() {
        ...
        assert_eq!(
            ...
            Some(vec![
                ...
                TerminalTitleItem::WeeklyLimit,
                TerminalTitleItem::KodexVersion,
