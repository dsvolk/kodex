...
use kodex_experimental_api_macros::ExperimentalApi;
use kodex_extension_items::ExtensionItem;
pub use kodex_extension_items::image_generation::ImageGenerationFailure;
pub use kodex_extension_items::image_generation::ImageGenerationItem;
pub use kodex_extension_items::sleep::SleepItem;
pub use kodex_extension_items::web_search::WebSearchAction;
pub use kodex_extension_items::web_search::WebSearchItem;
use kodex_protocol::approvals::ExecApprovalKind as CoreExecApprovalKind;
use kodex_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use kodex_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use kodex_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use kodex_protocol::items::AgentMessageContent as CoreAgentMessageContent;
pub use kodex_protocol::items::AgentMessageDelivery;
pub use kodex_protocol::items::AsyncUserInputQuestion;
...
pub use kodex_protocol::items::McpAppDisplayMode;
pub use kodex_protocol::items::McpAppUi;
...
use kodex_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use kodex_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use kodex_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use kodex_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use kodex_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub enum ThreadItem {
    ...
    CommandExecution {
        ...
        #[schemars(skip)]
        #[ts(skip)]
        model_context: Option<kodex_protocol::items::ModelInvocationContext>,
        id: String,
...
pub(crate) fn web_search_action_from_core(
    value: kodex_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        kodex_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        kodex_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        kodex_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        kodex_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<kodex_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: kodex_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<kodex_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: kodex_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for kodex_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
