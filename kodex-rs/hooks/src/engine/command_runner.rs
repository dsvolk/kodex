...
pub(crate) async fn run_command(
    ...
    unsafe {
        command.pre_exec(kodex_utils_pty::process_group::detach_from_tty);
    }
...
impl Drop for ProcessTreeGuard {
    fn drop(&mut self) {
        ...
        #[cfg(unix)]
        {
            let _ = kodex_utils_pty::process_group::kill_process_group(process_id);
        }
