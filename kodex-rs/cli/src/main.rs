...
struct AppServerCommand {
    ...
    #[command(flatten)]
    auth: kodex_websocket_auth::WebsocketAuthArgs,
}
...
mod tests {
    ...
    fn app_server_capability_token_flags_parse() {
        ...
        assert_eq!(
            ...
            Some(kodex_websocket_auth::WebsocketAuthCliMode::CapabilityToken)
        );
        assert_eq!(
    ...
    fn app_server_signed_bearer_flags_parse() {
        ...
        assert_eq!(
            app_server.auth.ws_auth,
            Some(kodex_websocket_auth::WebsocketAuthCliMode::SignedBearerToken)
        );
        assert_eq!(
