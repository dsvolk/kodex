...
use kodex_protocol::items::McpToolCallError as CoreMcpToolCallError;
use kodex_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use kodex_protocol::mcp::McpServerInfo;
use kodex_protocol::mcp::Resource as McpResource;
pub use kodex_protocol::mcp::ResourceContent as McpResourceContent;
use kodex_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use kodex_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from kodex_protocol::protocol::McpAuthStatus {
        Unknown,
        Unsupported,
        NotLoggedIn,
        BearerToken,
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from kodex_protocol::protocol::McpStartupFailureReason {
...
v2_enum_from_core!(
    ...
    pub enum McpServerConnectionStatus from kodex_protocol::mcp::McpServerConnectionStatus {
        NotStarted,
        Starting,
        Connected,
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> kodex_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => kodex_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => kodex_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => kodex_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Kodex turn when this elicitation was observed, if app-server could correlate one.
    ///
