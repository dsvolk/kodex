...
pub(super) fn cleanup_firewall_rules() -> Result<()> {
    ...
    for name in [
        "kodex_sandbox_offline_block_outbound",
        "kodex_sandbox_offline_block_inbound",
        "kodex_sandbox_offline_block_loopback_tcp",
        "kodex_sandbox_offline_block_loopback_udp",
        "kodex_sandbox_offline_allow_loopback_proxy",
    ] {
