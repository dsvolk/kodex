use super::*;
use kodex_core::exec_env::inject_apply_patch_env;
...
impl CommandExecRequestProcessor {
    ...
    async fn exec_one_off_command_inner(
        ...
        let kodex_linux_sandbox_exe = self.arg0_paths.kodex_linux_sandbox_exe.clone();
        ...
        let exec_request = kodex_core::exec::build_exec_request(
            exec_params,
            &effective_permission_profile,
            &sandbox_cwd,
            windows_sandbox_workspace_roots.as_slice(),
            &kodex_linux_sandbox_exe,
            &self.arg0_paths.kodex_self_exe,
            self.config.effective_local_windows_sandbox_type(),
            use_legacy_landlock,
        )
