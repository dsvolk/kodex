//! Captures how this Kodex process was launched.
//!
...
/// Builds the process provenance row for the current Kodex executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled Kodex package.");
    }
    check
}
