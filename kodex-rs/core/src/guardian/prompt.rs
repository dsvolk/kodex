...
use kodex_guardian_context::Budgeted;
use kodex_guardian_context::CollectedContext;
use kodex_guardian_context::ComposedContext;
use kodex_guardian_context::ContextPresentation;
use kodex_guardian_context::ContextProfile;
#[cfg(test)]
use kodex_guardian_context::ConversationTranscriptEntry;
use kodex_guardian_context::GuardianRootMessage;
use kodex_guardian_context::PermissionContext;
use kodex_guardian_context::PlannedAction;
use kodex_guardian_context::PlannedActionKind;
use kodex_guardian_context::SectionError;
use kodex_guardian_context::SectionHistory;
use kodex_guardian_context::SectionInput;
pub(crate) use kodex_guardian_context::TranscriptCursor as GuardianTranscriptCursor;
pub(crate) use kodex_guardian_context::TranscriptMode as GuardianPromptMode;
use kodex_guardian_context::TranscriptSelection;
use kodex_guardian_context::default_registry;
...
pub(super) fn collect_guardian_context(
    ...
    node_repl: Option<&kodex_guardian_context::NodeReplContext<'_>>,
...
pub(crate) fn guardian_truncate_text(content: &str, token_cap: usize) -> (String, bool) {
    (
        kodex_guardian_context::truncate_text(content, token_cap),
