...
"#;
    ...
    ToolSpec::Freeform(FreeformTool {
        ...
        description: kodex_code_mode::build_exec_tool_description(
            enabled_tools,
            deferred_tools,
...
mod tests {
    ...
    fn create_code_mode_tool_matches_expected_spec() {
        let enabled_tools = vec![kodex_code_mode::ToolDefinition {
            name: "update_plan".to_string(),
            tool_name: ToolName::plain("update_plan"),
            description: "Update the plan".to_string(),
            kind: kodex_code_mode::CodeModeToolKind::Function,
            input_schema: None,
            output_schema: None,
        }];
