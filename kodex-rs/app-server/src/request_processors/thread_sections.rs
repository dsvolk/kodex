...
use kodex_app_server_protocol::ThreadSectionCreateResponse;
use kodex_app_server_protocol::ThreadSectionDeleteParams;
use kodex_app_server_protocol::ThreadSectionDeleteResponse;
...
use kodex_app_server_protocol::ThreadSectionUpdateResponse;
use kodex_state::PINNED_THREAD_SECTION_ID;
use kodex_thread_store::CreateThreadSectionParams as StoreCreateThreadSectionParams;
use kodex_thread_store::DeleteThreadSectionParams as StoreDeleteThreadSectionParams;
use kodex_thread_store::ListThreadSectionsParams as StoreListThreadSectionsParams;
use kodex_thread_store::RenameThreadSectionParams as StoreRenameThreadSectionParams;
use kodex_thread_store::StoredThreadSection;
...
fn state_thread_section_appearance(
    appearance: ThreadSectionAppearance,
) -> kodex_state::ThreadSectionAppearance {
    kodex_state::ThreadSectionAppearance {
        icon: appearance.icon,
        color: appearance.color,
    }
