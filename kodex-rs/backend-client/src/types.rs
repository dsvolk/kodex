pub use kodex_backend_openapi_models::models::ConfigBundleResponse;
pub use kodex_backend_openapi_models::models::CreditStatusDetails;
pub use kodex_backend_openapi_models::models::DeliveredConfigToml;
pub use kodex_backend_openapi_models::models::DeliveredManagedLayers;
pub use kodex_backend_openapi_models::models::DeliveredRequirementsToml;
pub use kodex_backend_openapi_models::models::DeliveredTomlFragment;
pub use kodex_backend_openapi_models::models::PaginatedListTaskListItem;
pub use kodex_backend_openapi_models::models::PlanType;
pub use kodex_backend_openapi_models::models::RateLimitReachedKind;
pub use kodex_backend_openapi_models::models::RateLimitStatusDetails;
pub use kodex_backend_openapi_models::models::RateLimitStatusPayload;
pub use kodex_backend_openapi_models::models::RateLimitWindowSnapshot;
pub use kodex_backend_openapi_models::models::SpendControlLimitDetails;
pub use kodex_backend_openapi_models::models::TaskListItem;
...
pub(crate) struct AdditionalRateLimitWithNormalModel {
    #[serde(flatten)]
    pub details: kodex_backend_openapi_models::models::AdditionalRateLimitDetails,
    pub normal_model_slug: Option<String>,
}

#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct KodexWorkspaceMessagesResponse {
    #[serde(default)]
    pub messages: Vec<KodexWorkspaceMessage>,
}

/// Authenticated Kodex user settings used by CLI runtime policy.
#[derive(Clone, Copy, Debug, Default, Deserialize, PartialEq, Eq)]
pub struct KodexUserSettingsResponse {
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct KodexWorkspaceMessage {
    pub message_id: String,
    pub message_type: KodexWorkspaceMessageType,
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum KodexWorkspaceMessageType {
    Headline,
    Announcement,
    #[serde(other)]
    Unknown,
...
pub struct AccountEntry {
    ...
    #[serde(default)]
    pub plan_type: Option<kodex_protocol::account::PlanType>,
...
Second line"
    ...
    fn workspace_messages_response_deserializes_messages() {
        let response: KodexWorkspaceMessagesResponse = serde_json::from_value(serde_json::json!({
            "messages": [
                {
        ...
        assert_eq!(
            response,
            KodexWorkspaceMessagesResponse {
                messages: vec![
                    KodexWorkspaceMessage {
                        message_id: "headline-id".to_string(),
                        message_type: KodexWorkspaceMessageType::Headline,
                    ...
                    KodexWorkspaceMessage {
                        ...
                        message_type: KodexWorkspaceMessageType::Announcement,
                    ...
                    KodexWorkspaceMessage {
                        ...
                        message_type: KodexWorkspaceMessageType::Unknown,
