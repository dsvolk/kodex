...
_repo_root = os.environ.get("KODEX_REPO_ROOT")
if _repo_root is None:
    raise RuntimeError(
        "KODEX_REPO_ROOT must point to the repository root; "
        "run `just assemble-kodex-package` to set it automatically"
    )
...
PACKAGE_VARIANTS: dict[str, PackageVariant] = {
    "kodex": PackageVariant(
        name="kodex",
        cargo_bin="kodex",
        executable_stem="kodex",
    ),
    "kodex-app-server": PackageVariant(
        name="kodex-app-server",
        cargo_bin="kodex-app-server",
        executable_stem="kodex-app-server",
    ),
}
