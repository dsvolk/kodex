...
pub use kodex_protocol::protocol::GitSha;
...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $KODEX_HOME directory.
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [kodex_protocol::protocol::PatchApplyBeginEvent]
    /// and [kodex_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [kodex_protocol::protocol::ExecCommandBeginEvent]
    /// and [kodex_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
