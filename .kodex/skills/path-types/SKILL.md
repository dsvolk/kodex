---
name: path-types
description: Choose Rust types for operating system paths across the Kodex repository. Use when defining new path-bearing types or explicitly migrating existing ones.
---
