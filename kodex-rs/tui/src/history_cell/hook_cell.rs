...
use kodex_app_server_protocol::HookOutputEntry;
use kodex_app_server_protocol::HookOutputEntryKind;
use kodex_app_server_protocol::HookRunStatus;
use kodex_app_server_protocol::HookRunSummary;
use ratatui::prelude::*;
...
mod tests {
    ...
    fn completed_hook_with_only_context_is_quiet_on_every_tui_surface() {
        let cell = completed_hook_cell(
            ...
            vec![HookOutputEntry {
                kind: HookOutputEntryKind::Context,
                text: "## Working Memory Recall\n\nSource: Kodex compaction".to_string(),
            }],
        );
