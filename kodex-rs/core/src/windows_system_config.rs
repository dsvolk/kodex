...
use kodex_config::loader::WindowsSystemConfigNamespaceProbe as Probe;
use std::sync::atomic::AtomicBool;
use std::sync::atomic::Ordering;

const NAMESPACE_SQUATTING_PROBE_METRIC: &str =
    "kodex.windows_system_config.namespace_squatting_probe";
...
pub(crate) fn emit_namespace_squatting_probe() {
    ...
    let result = match kodex_config::loader::probe_windows_system_config_namespace() {
