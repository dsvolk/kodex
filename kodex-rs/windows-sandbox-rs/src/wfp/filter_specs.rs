...
pub(super) const FILTER_SPECS: &[FilterSpec] = &[
    FilterSpec {
        ...
        name: "kodex_wfp_icmp_connect_v4",
    ...
    FilterSpec {
        ...
        name: "kodex_wfp_icmp_connect_v6",
