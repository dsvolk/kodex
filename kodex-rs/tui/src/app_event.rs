...
use kodex_realtime_webrtc::StartedRealtimeWebrtcSession;
...
pub(crate) struct ManagedWorktreeTransition {
    ...
    pub(crate) manager: kodex_worktree::WorktreeManager,
    pub(crate) checkout: kodex_worktree::ManagedWorktree,
...
pub(crate) struct ManagedWorktreeCreated {
    ...
    pub(crate) result: Result<
        (
            kodex_worktree::WorktreeManager,
            kodex_worktree::ManagedWorktree,
        ),
        String,
    >,
}
...
pub(crate) enum AppEvent {
    ...
    UserVerificationFinished {
        ...
        request_id: AppServerRequestId,
        attempt_id: Uuid,
        result: Result<kodex_app_server_protocol::UserVerificationProof, String>,
    },
    ...
    /// Open the current thread in Kodex Desktop.
    OpenDesktopThread {
        thread_id: ThreadId,
    },
    ...
    HooksLoaded {
        cwd: PathBuf,
        result: Result<kodex_app_server_protocol::HooksListResponse, String>,
    },
    ...
    RealtimeWebrtcConnected {
        thread_id: ThreadId,
        attempt_id: u64,
        result: Result<(), kodex_realtime_webrtc::ConnectionError>,
    },
    ...
    PersistRealtimeVoiceSelection {
        voice: kodex_protocol::protocol::RealtimeVoice,
    },
    ...
    FetchExperimentalFeatures {
        ...
        response_tx: tokio::sync::oneshot::Sender<
            Result<Vec<kodex_app_server_protocol::ExperimentalFeature>, String>,
        >,
    },
