...
pub(crate) fn server_version_notice_for_tui(
    settings: &kodex_config::types::Tui,
    client: &str,
    server: Option<&str>,
) -> Option<String> {
...
mod tests {
    ...
    fn server_version_notice_uses_client_release_policy() {
        assert_eq!(
            ...
            Some("A background Kodex service is running v0.152.1, older than your Kodex CLI v0.153.0.".to_string())
        );
        assert_eq!(server_version_notice("0.153.0", Some("0.153.0")), None);
        assert_eq!(
            server_version_notice("0.0.0", Some("0.152.1")),
            Some("A background Kodex service is running v0.152.1, different from your Kodex CLI v0.0.0.".to_string())
        );
        assert_eq!(server_version_notice("0.153.0", /*server*/ None), None);
        assert_eq!(
            server_version_notice("0.153.0-alpha.10", Some("0.153.0-alpha.9")),
            Some("A background Kodex service is running v0.153.0-alpha.9, older than your Kodex CLI v0.153.0-alpha.10.".to_string())
        );
        ...
        assert_eq!(
            ...
            Some("A background Kodex service is running v0.156.0, different from your Kodex CLI v0.155.0-alpha.12.".to_string())
        );
    }
