...
use kodex_app_server_protocol::GuardianApprovalReview;
use kodex_app_server_protocol::GuardianApprovalReviewAction;
use kodex_app_server_protocol::GuardianApprovalReviewStatus;
use kodex_app_server_protocol::GuardianCommandSource as AppServerGuardianCommandSource;
use kodex_app_server_protocol::InitializeCapabilities;
use kodex_app_server_protocol::InitializeParams;
use kodex_app_server_protocol::ItemGuardianApprovalReviewCompletedNotification;
    ...
    ServerRequest::PermissionsRequestApproval {
        ...
        params: PermissionsRequestApprovalParams {
            ...
            permissions: RequestPermissionProfile {
                network: Some(kodex_app_server_protocol::AdditionalNetworkPermissions {
                    enabled: Some(true),
                }),
                file_system: None,
            },
...
fn sample_guardian_review_completed(
    ...
    ServerNotification::ItemGuardianApprovalReviewCompleted(
        ItemGuardianApprovalReviewCompletedNotification {
            ...
            decision_source: kodex_app_server_protocol::AutoReviewDecisionSource::Agent,
...
fn review_event_serializes_expected_shape() {
    let event = TrackEventRequest::ReviewEvent(KodexReviewEventRequest {
        ...
        event_params: KodexReviewEventParams {
            ...
            app_server_client: KodexAppServerClientMetadata {
                product_client_id: "kodex_tui".to_string(),
            ...
            runtime: KodexRuntimeMetadata {
                kodex_rs_version: "0.99.0".to_string(),
...
async fn guardian_review_event_ingests_custom_fact_with_optional_target_item() {
        ...
        .ingest(
            AnalyticsFact::Custom(CustomAnalyticsFact::GuardianReview(Box::new(
                GuardianReviewEventParams {
                    ...
                    guardian_default_review_model_id: Some("kodex-auto-review".to_string()),
    ...
    assert_eq!(payload[0]["event_type"], "kodex_guardian_review");
    assert_eq!(
...
async fn command_execution_approval_response_publishes_user_review_event() {
    for (kind, approval_id, subject, trigger) in [
        ...
        let payload = serde_json::to_value(&events).expect("serialize events");
        assert_eq!(payload.as_array().expect("events array").len(), 1);
        assert_eq!(payload[0]["event_type"], "kodex_review_event");
...
async fn guardian_completed_notification_publishes_review_event_with_thread_metadata() {
    ...
    assert_eq!(payload["event_type"], "kodex_review_event");
...
async fn guardian_events_keep_thread_source_and_originator_with_explicit_turn_connection() {
    ...
    let parent_thread_id =
        kodex_protocol::ThreadId::from_string("44444444-4444-4444-4444-444444444444")
    ...
    assert_eq!(params.runtime.kodex_rs_version, "0.1.0");
