...
use kodex_analytics::PluginInstallSource;
use kodex_app_server_protocol::PluginAvailability;
use kodex_app_server_protocol::PluginSharePrincipalRole;
use kodex_app_server_protocol::PluginShareTargetRole;
use kodex_config::types::McpServerConfig;
use kodex_core_plugins::OPENAI_CURATED_MARKETPLACE_NAME;
use kodex_core_plugins::PluginListBackgroundTaskOptions;
use kodex_core_plugins::PluginMarketplaceContext;
use kodex_core_plugins::RemotePluginInstallRequest;
use kodex_core_plugins::RemotePluginOperationError;
use kodex_core_plugins::RemotePluginOperationErrorKind;
use kodex_core_plugins::is_openai_curated_marketplace_name;
use kodex_core_plugins::loader::load_configured_plugin_mcp_servers;
use kodex_core_plugins::manifest::is_agent_plugin_manifest;
use kodex_core_plugins::remote::REMOTE_CREATED_BY_ME_MARKETPLACE_NAME;
use kodex_core_plugins::remote::REMOTE_GLOBAL_MARKETPLACE_NAME;
use kodex_core_plugins::remote::REMOTE_WORKSPACE_MARKETPLACE_NAME;
use kodex_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_MARKETPLACE_NAME;
...
use kodex_core_plugins::remote::RemoteAppTemplateUnavailableReason;
use kodex_core_plugins::remote::RemotePluginCatalogCacheMode;
use kodex_core_plugins::remote::RemotePluginScope;
use kodex_core_plugins::remote::is_valid_remote_plugin_id;
use kodex_core_plugins::remote::validate_remote_plugin_id;
use kodex_core_plugins::remote_bundle::RemotePluginBundleInstallError;
use kodex_mcp::McpOAuthLoginSupport;
use kodex_mcp::McpRuntimeContext;
use kodex_mcp::oauth_login_support;
use kodex_mcp::resolve_oauth_callback;
use kodex_mcp::should_retry_without_scopes;
use kodex_plugin::PluginId;
use kodex_plugin::PluginTelemetryMetadata;
use kodex_protocol::auth::AuthMode as DomainAuthMode;
...
use kodex_rmcp_client::perform_oauth_login_silent;
...
pub(crate) struct PluginRequestProcessor {
    ...
    on_effective_plugins_changed:
        Arc<dyn Fn(kodex_core_plugins::EffectivePluginsChange) + Send + Sync>,
}

fn plugin_skills_to_info<'a>(
    skills: impl IntoIterator<Item = &'a kodex_skills::SkillMetadata>,
    ...
    skills
        ...
        .map(|skill| SkillSummary {
            ...
            interface: skill.interface.clone().map(|interface| {
                kodex_app_server_protocol::SkillInterface {
...
fn load_shared_plugin_ids_by_local_path(
    ...
    kodex_core_plugins::remote::load_plugin_share_remote_ids_by_local_path(
...
fn convert_configured_marketplace_plugin_to_plugin_summary(
    plugin: kodex_core_plugins::ConfiguredMarketplacePlugin,
    shared_plugin_ids_by_local_path: &std::collections::BTreeMap<AbsolutePathBuf, String>,
) -> PluginSummary {
...
) -> kodex_core_plugins::remote::RemotePluginShareDiscoverability {
    match discoverability {
        PluginShareDiscoverability::Listed => {
            kodex_core_plugins::remote::RemotePluginShareDiscoverability::Listed
        }
        PluginShareDiscoverability::Unlisted => {
            kodex_core_plugins::remote::RemotePluginShareDiscoverability::Unlisted
        }
        PluginShareDiscoverability::Private => {
            kodex_core_plugins::remote::RemotePluginShareDiscoverability::Private
        }
    }
}
...
) -> kodex_core_plugins::remote::RemotePluginShareUpdateDiscoverability {
    match discoverability {
        PluginShareUpdateDiscoverability::Listed => {
            kodex_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Listed
        }
        PluginShareUpdateDiscoverability::Unlisted => {
            kodex_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Unlisted
        }
        PluginShareUpdateDiscoverability::Private => {
            kodex_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Private
        }
    }
}
...
) -> kodex_core_plugins::remote::RemotePluginShareTargetRole {
    match role {
        PluginShareTargetRole::Reader => {
            kodex_core_plugins::remote::RemotePluginShareTargetRole::Reader
        }
        PluginShareTargetRole::Editor => {
            kodex_core_plugins::remote::RemotePluginShareTargetRole::Editor
        }
    }
}

fn plugin_share_principal_role_from_remote(
    role: kodex_core_plugins::remote::RemotePluginSharePrincipalRole,
) -> PluginSharePrincipalRole {
    match role {
        kodex_core_plugins::remote::RemotePluginSharePrincipalRole::Reader => {
            PluginSharePrincipalRole::Reader
        }
        kodex_core_plugins::remote::RemotePluginSharePrincipalRole::Editor => {
            PluginSharePrincipalRole::Editor
        }
        kodex_core_plugins::remote::RemotePluginSharePrincipalRole::Owner => {
...
) -> Vec<kodex_core_plugins::remote::RemotePluginShareTarget> {
    targets
        .into_iter()
        .map(
            |target| kodex_core_plugins::remote::RemotePluginShareTarget {
                principal_type: match target.principal_type {
                    PluginSharePrincipalType::User => {
                        kodex_core_plugins::remote::RemotePluginSharePrincipalType::User
                    }
                    PluginSharePrincipalType::Group => {
                        kodex_core_plugins::remote::RemotePluginSharePrincipalType::Group
                    }
                    PluginSharePrincipalType::Workspace => {
                        kodex_core_plugins::remote::RemotePluginSharePrincipalType::Workspace
                    }
                },
...
fn plugin_share_principal_from_remote(
    principal: kodex_core_plugins::remote::RemotePluginSharePrincipal,
...
impl PluginRequestProcessor {
    pub(crate) fn new(
        ...
        on_effective_plugins_changed: Arc<
            dyn Fn(kodex_core_plugins::EffectivePluginsChange) + Send + Sync,
        >,
    ) -> Self {
        Self {
            auth_manager,
    ...
    async fn plugin_list_response(
        ...
        let auth_mode = auth.as_ref().map(KodexAuth::api_auth_mode);
        if include_local
            && force_refetch
            && plugins_manager
        ...
        let use_remote_global_catalog =
            include_global_remote && auth_mode.is_some_and(DomainAuthMode::uses_kodex_backend);
            ...
            match tokio::task::spawn_blocking(move || {
                ...
                Ok::<
                    (
                        ...
                        Vec<kodex_app_server_protocol::MarketplaceLoadErrorInfo>,
                        Vec<kodex_core_plugins::ConfiguredMarketplace>,
                    ),
                    MarketplaceError,
                >((
                    outcome
                    ...
                    outcome
                        .errors
                        .into_iter()
                        .map(|err| kodex_app_server_protocol::MarketplaceLoadErrorInfo {
        ...
        if include_vertical && !config.features.enabled(Feature::RemotePlugin) {
            match kodex_core_plugins::remote::fetch_openai_curated_remote_collection_marketplace(
        ...
        if !remote_sources.is_empty() {
            match kodex_core_plugins::remote::fetch_remote_marketplaces(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_sources,
                /*catalog_cache_root*/ Some(config.kodex_home.as_path()),
    ...
    async fn plugin_installed_response(
        ...
        let use_remote_global_catalog = context.remote_plugins_enabled()
            && auth_mode.is_some_and(DomainAuthMode::uses_kodex_backend);
    ...
    async fn load_local_installed_and_suggested_plugins(
        &self,
        plugins_manager: Arc<kodex_core_plugins::PluginsManager>,
        config: &Config,
    ...
    async fn load_remote_installed_plugins(
        &self,
        plugins_manager: Arc<kodex_core_plugins::PluginsManager>,
        plugins_input: &kodex_core_plugins::PluginsConfigInput,
        ...
        let plugin = match read_source {
            Ok(marketplace_path) => {
                ...
                let share_context = match share_context {
                    Some(context) => {
                        let remote_plugin_service_config = remote_plugin_service_config(&config);
                        match kodex_core_plugins::remote::fetch_remote_plugin_share_context(
                            &remote_plugin_service_config,
                            auth.as_ref(),
                ...
                PluginDetail {
                    ...
                    hooks: outcome
                        ...
                        .hooks
                        .into_iter()
                        .map(|hook| kodex_app_server_protocol::PluginHookSummary {
                            key: hook.key,
            ...
            Err(remote_marketplace_name) => {
                ...
                let remote_detail = kodex_core_plugins::remote::fetch_remote_plugin_detail(
                    &remote_plugin_service_config,
                    auth.as_ref(),
                    &remote_marketplace_name,
                    &plugin_name,
                ...
                let plugin_apps = remote_detail
                    ...
                    .iter()
                    .cloned()
                    .map(kodex_plugin::AppConnectorId)
                    .collect::<Vec<_>>();
    ...
    async fn plugin_skill_read_response(
        ...
        let auth = self.auth_manager.auth().await;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let remote_skill_detail = kodex_core_plugins::remote::fetch_remote_plugin_skill_detail(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_marketplace_name,
            &remote_plugin_id,
    ...
    async fn plugin_share_save_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let access_policy = kodex_core_plugins::remote::RemotePluginShareAccessPolicy {
        ...
        let result = kodex_core_plugins::remote::save_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.kodex_home.as_path(),
            &plugin_path,
        ...
        kodex_core_plugins::remote::invalidate_cached_remote_plugin_catalog_scopes(
            config.kodex_home.as_path(),
            &remote_plugin_service_config,
            auth.as_ref(),
    ...
    async fn plugin_share_update_targets_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = kodex_core_plugins::remote::update_remote_plugin_share_targets(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_plugin_id,
    ...
    async fn plugin_share_list_response(
        ...
        let (config, auth) = self.load_plugin_share_config_and_auth().await?;
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let data = kodex_core_plugins::remote::list_remote_plugin_shares(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.kodex_home.as_path(),
        )
    ...
    async fn plugin_share_checkout_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        let result = kodex_core_plugins::remote::checkout_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.kodex_home.as_path(),
            &remote_plugin_id,
    ...
    async fn plugin_share_delete_response(
        ...
        let remote_plugin_service_config = remote_plugin_service_config(&config);
        kodex_core_plugins::remote::delete_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.kodex_home.as_path(),
            &remote_plugin_id,
    ...
    async fn load_plugin_share_config_and_auth(
        &self,
    ) -> Result<(Config, Option<KodexAuth>), JSONRPCErrorError> {
        let config = self.load_latest_config(/*fallback_cwd*/ None).await?;
        if !config.features.enabled(Feature::Plugins) {
    ...
    async fn plugin_install_response(
        ...
        let plugin_mcp_servers = load_configured_plugin_mcp_servers(
            ...
            auth.as_ref().map(KodexAuth::auth_mode),
            &result.plugin_id,
    ...
    async fn remote_plugin_install_response(
        ...
        let is_chatgpt_auth = auth.as_ref().is_some_and(KodexAuth::is_chatgpt_auth);
    ...
    async fn plugin_apps_needing_auth_for_install(
        ...
        auth: Option<&KodexAuth>,
        plugin_id: &str,
        plugin_app_declarations: &[kodex_plugin::AppDeclaration],
    ) -> Vec<AppSummary> {
        if plugin_app_declarations.is_empty()
            || !config
                .features
                .apps_enabled_for_auth(auth.is_some_and(KodexAuth::is_chatgpt_auth))
        {
            return Vec::new();
        }

        let plugin_apps =
            kodex_plugin::app_connector_ids_from_declarations(plugin_app_declarations);
        ...
        let (accessible_connectors, kodex_apps_ready) = match accessible_connectors_result {
            Ok(status) => (status.connectors, status.kodex_apps_ready),
            Err(err) => {
                warn!(
                    plugin = plugin_id,
        ...
        if !kodex_apps_ready {
            warn!(
                plugin = plugin_id,
                "kodex_apps MCP not ready after plugin install; skipping appsNeedingAuth check"
            );
            return Vec::new();
        }
    ...
    async fn start_plugin_mcp_oauth_logins(
        ...
        for (name, server) in plugin_mcp_servers {
            ...
            if !server.enabled || matches!(server.auth, kodex_config::types::McpServerAuth::EmaAuth)
            {
                continue;
            }
    ...
    async fn plugin_uninstall_response(
        ...
        if kodex_plugin::PluginId::parse(&plugin_id).is_err()
...
async fn load_plugin_app_summaries(
    config: &Config,
    auth: Option<&KodexAuth>,
    plugin_apps: &[kodex_plugin::AppConnectorId],
    ...
    if let Some(auth) = auth.filter(|auth| {
        config
            .features
            .apps_enabled_for_auth(auth.uses_kodex_backend())
    }) {
        metadata_by_id.extend(
            kodex_connectors::ConnectorMetadataStore::new(
                config.chatgpt_base_url.clone(),
                auth.get_account_id(),
    ...
    app_ids
        ...
        .map(|app_id| {
            ...
            AppSummary {
                install_url: Some(kodex_connectors::metadata::connector_install_url(
                    &name, &app_id,
                )),
                id: app_id,
                name,
...
fn plugin_app_category_by_id_from_value(value: &serde_json::Value) -> HashMap<String, String> {
    kodex_core_plugins::loader::plugin_app_declarations_from_value(value)
        .into_iter()
...
fn remote_plugin_share_discoverability_to_info(
    discoverability: kodex_core_plugins::remote::RemotePluginShareDiscoverability,
...
fn remote_plugin_bundle_install_error_to_jsonrpc(
    err: kodex_core_plugins::remote_bundle::RemotePluginBundleInstallError,
) -> JSONRPCErrorError {
