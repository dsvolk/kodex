...
use kodex_config::permissions_toml::FilesystemPermissionToml::Access;
...
use kodex_protocol::permissions::FileSystemAccessMode::Deny;
use kodex_protocol::permissions::FileSystemAccessMode::Read;
use kodex_protocol::permissions::FileSystemAccessMode::Write;
...
use kodex_protocol::permissions::ReadDenyMatcher;
...
fn interior_dot_workspace_glob_fails_closed_for_every_path_convention() {
    ...
    let expected = (
        FileSystemSandboxPolicy::restricted(vec![
            ...
            deny_glob_entry("kodex-project-roots://private/./*.env"),
        ]),
        NetworkSandboxPolicy::Restricted,
    );
    for facts in executor_contexts() {
