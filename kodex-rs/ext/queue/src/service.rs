...
use kodex_thread_store::MAX_QUEUE_ITEMS;
use kodex_thread_store::QueueStore;
use kodex_thread_store::QueuedUserSubmissionRecord;
...
pub enum QueueServiceError {
    ...
    CoreSubmissionError(#[from] KodexErr),
