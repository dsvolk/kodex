...
pub use kodex_file_system::WalkOptions;
pub use kodex_file_system::WalkOutcome;
use kodex_file_system::WireFileSystemSandboxContext;
...
impl EnvironmentInfo {
    ...
    pub fn local() -> Self {
        #[cfg(windows)]
        let windows_mxc = kodex_mxc_sandbox::is_available();
        #[cfg(not(windows))]
        ...
        Self {
            shell: kodex_shell_command::shell_detect::default_user_shell().into(),
...
pub struct ExecParams {
    ...
    #[serde(default)]
    pub pipe_stdin: bool,
    /// Optional process-visible argv0 override. Values such as `kodex-linux-sandbox` are command
...
mod tests {
    ...
    use kodex_network_proxy::RemoteNetworkProxyLaunchConfig;
    use kodex_protocol::config_types::WindowsSandboxProxySettingsMode;
    ...
    fn exec_params_keeps_proxy_launch_separate_from_sandbox_facts() {
        ...
        let params = ExecParams {
            ...
            metadata: Some(ExecMetadata {
                thread_id: Some(kodex_protocol::ThreadId::new()),
