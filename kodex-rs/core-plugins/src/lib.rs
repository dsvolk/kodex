...
pub type LoadedPlugin = kodex_plugin::LoadedPlugin<kodex_config::McpServerConfig>;
pub type PluginLoadOutcome = kodex_plugin::PluginLoadOutcome<kodex_config::McpServerConfig>;
