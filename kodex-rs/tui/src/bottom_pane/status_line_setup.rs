...
pub(crate) enum StatusLineItem {
    ...
    /// Hostname of the machine running Kodex.
    Hostname,
...
impl StatusLineItem {
    ...
    pub(crate) fn description(self) -> &'static str {
        match self {
            ...
            StatusLineItem::KodexVersion => "Kodex application version",
    ...
    pub(crate) fn preview_item(self) -> StatusSurfacePreviewItem {
        match self {
            ...
            StatusLineItem::KodexVersion => StatusSurfacePreviewItem::KodexVersion,
