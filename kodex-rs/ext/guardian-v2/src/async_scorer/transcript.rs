...
pub(crate) use kodex_features::GuardianV2TranscriptSource as TranscriptSource;
...
use kodex_guardian_context::ConversationTranscriptConfig;
use kodex_guardian_context::ConversationTranscriptOptions;
use kodex_guardian_context::GuardianRootMessage;
#[cfg(test)]
use kodex_guardian_context::MANUAL_APPROVAL_DEVELOPER_PREFIX;
...
use kodex_guardian_context::TranscriptEntryLimits;
use kodex_guardian_context::TranscriptImageInput;
use kodex_guardian_context::TranscriptRetentionConfig;
...
pub(crate) struct ContextInput<'a> {
    ...
    pub(crate) node_repl_images: Option<&'a [kodex_protocol::models::ContentItem]>,
}
