...
pub(crate) struct ConfiguredHandler {
    ...
    pub builtin: bool,
    pub event_name: kodex_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            kodex_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            kodex_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            kodex_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            kodex_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            kodex_protocol::protocol::HookEventName::PostCompact => "post-compact",
            kodex_protocol::protocol::HookEventName::SessionStart => "session-start",
            kodex_protocol::protocol::HookEventName::SessionEnd => "session-end",
            kodex_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            kodex_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            kodex_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            kodex_protocol::protocol::HookEventName::Stop => "stop",
            kodex_protocol::protocol::HookEventName::Interrupt => "interrupt",
        }
    }
