...
//!
//! `kodex-rollout-trace` owns the event schema and writer behavior. This module
...
use kodex_rollout_trace::ToolDispatchInvocation;
use kodex_rollout_trace::ToolDispatchPayload;
use kodex_rollout_trace::ToolDispatchRequester;
use kodex_rollout_trace::ToolDispatchResult;
use kodex_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        kodex_turn_id: invocation.turn.sub_id.clone(),
