...
use kodex_analytics::ArtifactOperation;
use kodex_analytics::ArtifactOperationLifecycle;
use kodex_analytics::build_track_events_context;
use kodex_apply_patch::AppliedPatchDelta;
use kodex_core_plugins::PluginCommandAttribution;
use kodex_core_plugins::recognize_artifact_operation;
use kodex_otel::ARTIFACT_OPERATION_EXPECTED_OUTPUT_COUNT_METRIC;
use kodex_otel::ARTIFACT_OPERATION_STARTED_METRIC;
...
impl ToolEmitter {
    ...
    pub async fn finish(
        ...
        let (event, result) = match out {
            ...
            Err(ToolError::Kodex(err)) => match err.details() {
...
mod tests {
    ...
    async fn assert_failed_apply_patch_tracks_committed_delta(
        ...
        let delta = kodex_apply_patch::apply_patch(
    ...
    async fn denied_apply_patch_tracks_committed_delta() {
        ...
        assert_failed_apply_patch_tracks_committed_delta(
            Err(ToolError::Kodex(KodexErr::Sandbox(SandboxErr::Denied {
