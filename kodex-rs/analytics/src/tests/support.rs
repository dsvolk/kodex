...
use kodex_protocol::models::PermissionProfile as CorePermissionProfile;
...
pub(super) const TEST_PRODUCT_CLIENT_ID: &str = "kodex_work_desktop";
...
impl TurnAnalyticsMetadata for TestTurnMetadata {
    ...
    fn kodex_turn_source(&self) -> Option<String> {
        None
    }
}
...
pub(super) fn sample_app_server_client_metadata() -> KodexAppServerClientMetadata {
...
pub(super) fn sample_runtime_metadata() -> KodexRuntimeMetadata {
    KodexRuntimeMetadata {
        kodex_rs_version: "0.1.0".to_string(),
...
pub(super) fn sample_turn_start_response(turn_id: &str) -> ClientResponsePayload {
    ClientResponsePayload::TurnStart(kodex_app_server_protocol::TurnStartResponse {
        turn: Turn {
...
pub(super) fn sample_turn_completed_notification(
    ...
    kodex_error_info: Option<kodex_app_server_protocol::KodexErrorInfo>,
) -> ServerNotification {
    ServerNotification::TurnCompleted(TurnCompletedNotification {
        ...
        turn: Turn {
            ...
            items: vec![],
            status,
            error: kodex_error_info.map(|kodex_error_info| AppServerTurnError {
                misalignment: None,
    ...
    reducer
        .ingest(
            AnalyticsFact::Initialize {
                ...
                product_client_id: "kodex-tui".to_string(),
