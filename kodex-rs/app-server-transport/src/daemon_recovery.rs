...
pub struct InterruptedTurn {
    ...
    pub cyber_access_program: Option<kodex_protocol::turn_input::CyberAccessProgram>,
    ...
    pub local_environment: Option<kodex_app_server_protocol::ThreadEnvironment>,
}
...
const INTERRUPTION_PREFIX: &str = "kodex-interrupted-v1:";
