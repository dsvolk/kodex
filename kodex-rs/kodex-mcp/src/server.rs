...
use kodex_rmcp_client::StoredOAuthCredentialSnapshot;
...
pub(crate) struct McpServerConnectionIdentity {
    ...
    runtime_auth: Option<KodexAuth>,
    runtime_auth_token: Option<String>,
    kodex_apps_cache_identity: Option<(PathBuf, ConnectorRuntimeContextKey)>,
...
impl McpServerConnectionIdentity {
    ...
    pub(crate) fn has_same_connection_config(&self, other: &Self) -> bool {
        let same_runtime_auth = match (&self.runtime_auth, &other.runtime_auth) {
            (Some(KodexAuth::AgentIdentity(left)), Some(KodexAuth::AgentIdentity(right))) => {
        ...
        self.auth == other.auth
            ...
            && self.kodex_apps_cache_identity == other.kodex_apps_cache_identity
