...
use kodex_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use kodex_protocol::protocol::TokenUsage as CoreTokenUsage;
use kodex_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "kodex_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
    ...
    /// This is for internal use only (e.g. Kodex Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR KODEX CLOUD - DO NOT USE.
...
impl From<kodex_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: kodex_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> kodex_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => kodex_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => kodex_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `kodex_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
...
impl From<kodex_protocol::ResponseUsageMetadata> for ResponseUsageMetadata {
    fn from(value: kodex_protocol::ResponseUsageMetadata) -> Self {
        Self {
            amount: value.amount,
