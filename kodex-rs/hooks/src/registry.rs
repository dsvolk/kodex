...
impl Hooks {
    ...
    ) -> anyhow::Result<(Self, Receiver<kodex_protocol::protocol::HookCompletedEvent>)> {
    ...
    ) -> Vec<kodex_protocol::protocol::HookRunSummary> {
    ...
    pub fn preview_session_end(&self) -> Vec<kodex_protocol::protocol::HookRunSummary> {
    ...
    pub fn preview_interrupt(&self) -> Vec<kodex_protocol::protocol::HookRunSummary> {
