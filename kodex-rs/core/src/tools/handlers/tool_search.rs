...
use kodex_tools::TOOL_SEARCH_DEFAULT_LIMIT;
use kodex_tools::TOOL_SEARCH_TOOL_NAME;
use kodex_tools::ToolName;
use kodex_tools::ToolSearchEntry;
use kodex_tools::ToolSearchInfo;
use kodex_tools::ToolSpec;
use kodex_tools::coalesce_loadable_tool_specs;
use std::sync::Arc;
use std::sync::Mutex;
use std::sync::Weak;
...
mod tests {
    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        let dynamic_namespace = DynamicToolNamespaceSpec {
            ...
            description: "Tools in the kodex_app namespace.".to_string(),
            tools: Vec::new(),
        };
