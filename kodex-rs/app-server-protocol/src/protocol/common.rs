...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by Kodex.
    ApiKey,
    /// ChatGPT OAuth managed by Kodex (tokens persisted and refreshed by Kodex).
    Chatgpt,
    ...
    Headers,
    /// Programmatic Kodex auth backed by a registered Agent Identity.
    #[serde(rename = "agentIdentity")]
    #[ts(rename = "agentIdentity")]
    #[strum(serialize = "agentIdentity")]
    AgentIdentity,
    /// Programmatic Kodex auth backed by a personal access token.
    #[serde(rename = "personalAccessToken")]
    #[ts(rename = "personalAccessToken")]
    #[strum(serialize = "personalAccessToken")]
    PersonalAccessToken,
    /// Amazon Bedrock bearer token managed by Kodex.
    #[serde(rename = "bedrockApiKey")]
    #[ts(rename = "bedrockApiKey")]
    #[strum(serialize = "bedrockApiKey")]
    BedrockApiKey,
    /// Amazon Bedrock AWS access keys managed by Kodex.
...
impl AuthMode {
    ...
    /// Returns whether this mode is backed by Kodex services rather than a direct model API.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a Kodex sandbox.
...
/// Superset of [`kodex_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by Kodex Cloud.
...
mod tests {
    ...
    fn jsonrpc_request_conversion_preserves_serde_enum_decoding() {
        let requests = [
            JSONRPCRequest {
                ...
                trace: Some(kodex_protocol::protocol::W3cTraceContext {
        ...
        let response = ClientResponse::ThreadStart {
            ...
            response: v2::ThreadStartResponse {
                ...
                instruction_sources: vec![
                    kodex_utils_path_uri::LegacyAppPathString::from_abs_path(&absolute_path(
                        "/tmp/AGENTS.md",
                    )),
                ],
    ...
    fn account_serializes_fields_in_camel_case() -> Result<()> {
        ...
        let kodex_managed_bedrock = v2::Account::AmazonBedrock {
            uses_kodex_managed_credentials: true,
        };
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesKodexManagedCredentials": true,
            }),
            serde_json::to_value(&kodex_managed_bedrock)?,
        );
        ...
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesKodexManagedCredentials": false,
            }),
    ...
    fn serialize_thread_realtime_start() -> Result<()> {
        let request = ClientRequest::ThreadRealtimeStart {
            ...
            params: v2::ThreadRealtimeStartParams {
                ...
                kodex_response_handoff_channel_prefixes: Some(std::collections::BTreeMap::from([
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    ...
                    "kodexResponsesAsItems": null,
                    "kodexResponseItemPrefix": null,
                    "kodexResponseHandoffMode": "bemTags",
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    ...
                    "kodexResponsesAsItems": null,
                    "kodexResponseItemPrefix": null,
                    "kodexResponseHandoffMode": null,
                    "kodexResponseHandoffChannelPrefixes": null,
                    "model": null,
                    "outputModality": "audio",
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: kodex_protocol::config_types::CollaborationMode {
