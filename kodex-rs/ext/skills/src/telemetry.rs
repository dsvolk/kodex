...
pub(crate) struct SkillTurnMetrics {
    ...
    pub(crate) turn_metadata: Option<Arc<dyn kodex_analytics::TurnAnalyticsMetadata>>,
    model_slug: String,
...
impl SkillTurnMetrics {
    ...
    fn finish(&self, session_store: &ExtensionData, status: &str) {
        ...
        for plugin_id in usage.plugins {
            ...
            metrics.histogram(
                "kodex.skill.turn.duration_seconds",
                duration_seconds,
                &[
    ...
    fn on_turn_start<'a>(&'a self, input: TurnStartInput<'a>) -> ExtensionFuture<'a, ()> {
        Box::pin(async move {
            ...
            input.turn_store.insert(SkillTurnMetrics {
                ...
                turn_metadata: input
                    .turn_store
                    .get::<Arc<dyn kodex_analytics::TurnAnalyticsMetadata>>()
