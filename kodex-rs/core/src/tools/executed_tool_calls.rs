...
use kodex_protocol::models::ExecutedToolCallArguments;
use kodex_protocol::models::ResponseItem;
use kodex_protocol::models::bound_executed_tool_calls_for_prompt;
...
impl ExecutedToolCalls {
    ...
    fn record_tool_result_metadata(
        ...
        let metadata = kodex_protocol::models::ToolResultMetadata::new(metadata);
...
fn recorded_call(call: &ToolCall) -> (ExecutedToolCall, usize) {
    ...
    let name = kodex_tools::code_mode_name_for_tool_name(&call.tool_name);
