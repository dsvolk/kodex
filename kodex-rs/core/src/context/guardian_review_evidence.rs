...
use kodex_guardian_context::MAX_PREVIOUS_REVIEWS;
...
impl GuardianReviewEvidence {
    ...
    pub fn user_input_snapshot(
        ...
        match history.retained_context() {
            Some(context) => {
                let answers = kodex_guardian_context::render_verified_answers(context);
    ...
    pub(crate) fn user_input_for_call(
        ...
        match history.retained_context() {
            Some(context) => context
                ...
                .and_then(kodex_guardian_context::render_verified_answer),
            None => self
                .state
                .lock()
