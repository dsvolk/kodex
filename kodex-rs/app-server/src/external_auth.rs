...
use kodex_app_server_protocol::ChatgptAuthTokensRefreshParams;
...
use kodex_login::auth::ExternalAuthRefreshReason;
...
pub(crate) struct ExternalAuthBridge {
    ...
    auth: RwLock<KodexAuth>,
}

impl ExternalAuthBridge {
    pub(crate) fn new(outgoing: Arc<OutgoingMessageSender>, auth: KodexAuth) -> Self {
        Self {
            outgoing,
    ...
    async fn refresh(&self, context: ExternalAuthRefreshContext) -> std::io::Result<KodexAuth> {
