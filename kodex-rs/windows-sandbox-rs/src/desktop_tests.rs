...
fn private_desktop_rejects_interactive_and_injected_names() {
    for name in [
        ...
        r"Winsta0\Default",
        "KodexSandboxDesktop-",
        r"KodexSandboxDesktop-abcd\Default",
        "KodexSandboxDesktop-abcd\0Default",
        "KodexSandboxDesktop-0123456789abcdef0123456789abcdef0",
    ] {
...
fn legacy_desktop_reuses_only_equivalent_permissions() -> Result<()> {
    ...
    let security = prepare_legacy_session_security(
        ...
        &kodex_home,
        &workspace,
        legacy_session_capability_roots(&permissions, &workspace, &env, &kodex_home),
    )?;
