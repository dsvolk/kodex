...
use kodex_shell_command::powershell::extract_powershell_command;

const CANONICAL_BASH_SCRIPT_PREFIX: &str = "__kodex_shell_script__";
const CANONICAL_POWERSHELL_SCRIPT_PREFIX: &str = "__kodex_powershell_script__";
