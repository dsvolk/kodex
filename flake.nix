{
  description = "Development Nix flake for OpenAI Kodex CLI";
  ...
  outputs = { self, nixpkgs, rust-overlay, ... }:
    let
      ...
      cargoToml = builtins.fromTOML (builtins.readFile ./kodex-rs/Cargo.toml);
    ...
    in
    {
      packages = forAllSystems (system:
        let
          ...
          kodex-rs = pkgs.callPackage ./kodex-rs {
            inherit version;
