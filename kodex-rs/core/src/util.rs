pub use kodex_async_utils::backoff;
use tracing::error;

/// Emit structured feedback metadata as key/value pairs.
///
/// This logs a tracing event with `target: "feedback_tags"`. If
/// `kodex_feedback::KodexFeedback::metadata_layer()` is installed, these fields are captured and
...
///
/// kodex_core::feedback_tags!(model = "gpt-5", cached = true);
/// kodex_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
