...
impl FilesystemDenyReadPattern {
    ...
    pub fn from_input(input: &str) -> Result<Self, String> {
        kodex_utils_path_uri::PathUri::validate_config_path_text(
            input,
        ...
        if crate::path_context::convention() == kodex_utils_path_uri::PathConvention::Windows
...
fn validate_literal_denial_path(path: &str) -> Result<(), String> {
    ...
    kodex_utils_path_uri::LegacyAppPathString::from_string(path)
    ...
    match separator_index {
        ...
        Some(index)
            if crate::path_context::convention()
                == kodex_utils_path_uri::PathConvention::Windows
                && index == 2
...
mod tests {
    ...
    fn auto_review_required_for_model_matches_exact_provider_aliases() {
        ...
        for (model, protected) in [
            ...
            ("openai-kodex/protected-model-preview", false),
