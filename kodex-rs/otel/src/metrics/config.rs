...
const CONVERSATION_TURN_COUNT_METRIC: &str = "kodex.conversation.turn.count";

// Metrics intentionally not sent through Kodex's built-in Statsig route.
...
pub struct MetricsConfig {
    pub(crate) http_client_factory: kodex_http_client::HttpClientFactory,
