...
pub fn build_guardian_review_session_config(
    ...
    live_network_config: Option<kodex_network_proxy::NetworkProxyConfig>,
    active_model: &str,
    reasoning_effort: Option<kodex_protocol::openai_models::ReasoningEffort>,
    reasoning_summary: kodex_protocol::config_types::ReasoningSummary,
...
pub(crate) async fn resolve_review_model(
    ...
    kodex_guardian_reviewer::ReviewModel,
    Arc<kodex_protocol::openai_models::ModelInfo>,
) {
    ...
    let review_model = kodex_guardian_reviewer::select_review_model(
        &context.model_info,
